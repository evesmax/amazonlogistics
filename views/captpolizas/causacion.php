...
<div id='Causacion' title='Desglose de IVA Causado'><input type='hidden' id='idp'><input type='hidden' id='existe'>
	<TABLE id='contex'>
		<tr  style='background-color:#BDBDBD;color:white;font-weight:bold;'>
		<th width='200' class="nmcatalogbusquedatit">Base Gravable</th><th width='200' class="nmcatalogbusquedatit">Importe Total</th><th width='200' class="nmcatalogbusquedatit">Importe Base</th><th width='200' class="nmcatalogbusquedatit">IVA</th><th width='200' class="nmcatalogbusquedatit">IVA Pagado No Acreditable</th>
		</tr>
		<tr tipo='trtasa' onMouseOver="this.className='over'" onMouseOut="this.className='out'">
			<td>Tasa 16%</td><td><input tabindex='1' type='text' class="nminputtext" id='ImporteTotal16' tipo='numero' onchange="modificaImporteTotal('16')"></td><td><input tabindex='2' type='text' class="nminputtext" id='ImporteBase16' tipo='numero' onchange='recalculaTotales()'></td><td><input tabindex='3' type='text' class="nminputtext" id='IVA16' tipo='numero' onchange='recalculaTotales()'></td><td><input type='text' class="nminputtext" id='IVANoAc16' tipo='numero' onchange='comparaIVA(16);recalculaTotales()' tabindex='4'></td>
		</tr>
		<tr tipo='trtasa' onMouseOver="this.className='over'" onMouseOut="this.className='out'">
			<td>Tasa 11%</td><td><input tabindex='1' type='text' class="nminputtext" id='ImporteTotal11' tipo='numero' onchange="modificaImporteTotal('11')"></td><td><input tabindex='2' type='text' class="nminputtext" id='ImporteBase11' tipo='numero' onchange='recalculaTotales()'></td><td><input tabindex='3' type='text' class="nminputtext" id='IVA11' tipo='numero' onchange='recalculaTotales()'></td><td><input type='text' class="nminputtext" id='IVANoAc11' tipo='numero' onchange='comparaIVA(11);recalculaTotales()' tabindex='4'></td>
		</tr>
		<tr tipo='trtasa' onMouseOver="this.className='over'" onMouseOut="this.className='out'">
			<td>Tasa 0%</td><td><input tabindex='1' type='text' class="nminputtext" id='ImporteTotal0' tipo='numero' onchange="modificaImporteTotal('0')"></td><td><input tabindex='2' type='text' class="nminputtext" id='ImporteBase0' tipo='numero' onchange='recalculaTotales()'></td><td><input type='text' class="nminputtext" tipo='numero' disabled onchange='recalculaTotales()'></td><td><input type='text' class="nminputtext" tipo='numero' disabled onchange='recalculaTotales()'></td>
		</tr>
		<tr tipo='trtasa' onMouseOver="this.className='over'" onMouseOut="this.className='out'">
			<td>Tasa exenta</td><td><input tabindex='1' type='text' class="nminputtext" id='ImporteTotalExenta' tipo='numero' onchange="modificaImporteTotal('Exenta')"></td><td><input tabindex='2' type='text' class="nminputtext" id='ImporteBaseExenta' tipo='numero'onchange='recalculaTotales()'></td><td><input type='text' class="nminputtext" tipo='numero' disabled onchange='recalculaTotales()'></td><td><input type='text' class="nminputtext" class="nminputtext" tipo='numero' disabled onchange='recalculaTotales()'></td>
		</tr>
		<tr tipo='trtasa' onMouseOver="this.className='over'" onMouseOut="this.className='out'">
			<td>Tasa 15%</td><td><input tabindex='1' type='text' class="nminputtext" id='ImporteTotal15' tipo='numero' onchange="modificaImporteTotal('15')"></td><td><input tabindex='2' type='text' class="nminputtext" id='ImporteBase15' tipo='numero' onchange='recalculaTotales()'></td><td><input tabindex='3' type='text' class="nminputtext" id='IVA15' tipo='numero' onchange='recalculaTotales()'></td><td><input type='text' class="nminputtext" id='IVANoAc15' tipo='numero' onchange='comparaIVA(15);recalculaTotales()' tabindex='4'></td>
		</tr>
		<tr tipo='trtasa' onMouseOver="this.className='over'" onMouseOut="this.className='out'">
			<td>Tasa 10%</td><td><input tabindex='1' type='text' class="nminputtext" id='ImporteTotal10' tipo='numero' onchange="modificaImporteTotal('10')"></td><td><input tabindex='2' type='text' class="nminputtext" id='ImporteBase10' tipo='numero' onchange='recalculaTotales()'></td><td><input tabindex='3' type='text' class="nminputtext" id='IVA10' tipo='numero' onchange='recalculaTotales()'></td><td><input type='text' class="nminputtext" id='IVANoAc10' tipo='numero' onchange='comparaIVA(10);recalculaTotales()' tabindex='4'></td>
		</tr>
		<tr tipo='trtasa' onMouseOver="this.className='over'" onMouseOut="this.className='out'">
			<td>Otras Tasas</td><td><input tabindex='1' type='text' class="nminputtext" id='ImporteTotalOtras' tipo='numero' onchange="modificaImporteTotal('Otras')"></td><td><input tabindex='2' type='text' class="nminputtext" id='ImporteBaseOtras' tipo='numero' onchange='recalculaTotales()'></td><td><input tabindex='3' type='text' class="nminputtext" id='IVAOtras' tipo='numero' onchange='recalculaTotales()'></td><td><input type='text' class="nminputtext" id='IVANoAcOtras' tipo='numero' onchange="comparaIVA('Otras');recalculaTotales()" tabindex='4'></td>
		</tr>
		<tr tipo='trtasa' onMouseOver="this.className='over'" onMouseOut="this.className='out'">
			<td><i style='color:red;'>IVA Retenido</i></td><td><input tabindex='1' type='text' class="nminputtext" class="nminputtext" id='ImporteTotalIvaRetenido' tipo='numero' onchange='modificaIvaRetenido()'></td><td><input type='text' class="nminputtext" tipo='numero' onchange='recalculaTotales()' disabled></td><td><input type='text' class="nminputtext" id='IvaIvaRetenido' tipo='numero' onchange='recalculaTotales()' disabled></td><td><input type='text' class="nminputtext" tipo='numero' disabled onchange='recalculaTotales()'></td>
		</tr>
		<tr tipo='trtasa' onMouseOver="this.className='over'" onMouseOut="this.className='out'">

<?php
	...
	switch($reg{'tipo'}){
		...
		case "auto_increment":
			...
			$objeto = "
						<input id='i".$reg{'idcampo'}."'        ".$deshabilitado."
						       name='i".$reg{'idcampo'}."' 
						       type='text' 
							   last_class=' nminputtext nminputtextdisabled '
							   class=' form-control '
							   disabled size='15'
					...
					<table border=0>
						<tr>
							<td style='white-space:nowrap'>
								<div class='btn-group'>
				 					<a class='btn btn-default btn-xs' title='Descargar archivo' href=\"../descarga_archivo_fisico.php?d=1&f=".$valor."&ne=".$_SESSION['nombreestructura']."\" target='blank'>
				 						<i class='fa fa-arrow-circle-down'></i>
				 					</a>
				 					<a class='btn btn-default btn-xs' title='Ver archivo' href=\"../descarga_archivo_fisico.php?d=0&f=".$valor."&ne=".$_SESSION['nombreestructura']."\" target='blank'>
				...
				$objeto.= "
						<table border=0>
							<tr>
								<td>
									<div class='btn-group'>
				 					<a class='btn btn-default' title='Descargar archivo' href=\"../descarga_archivo.php?d=1&s=".$sql_w_file."&nc=".$reg{'nombrecampo'}."&ne=".$_SESSION['nombreestructura']."\" target='blank'>
				 						<i class='fa fa-arrow-circle-down'></i>
				 					</a>
				 					<a class='btn btn-default' title='Ver archivo' href=\"../descarga_archivo.php?d=0&s=".$sql_w_file."&nc=".$reg{'nombrecampo'}."&ne=".$_SESSION['nombreestructura']."\" target='blank'>
				 						<i class='fa fa-file-o'></i>
				 					</a>
				 					</div>
								</td>								
		...
		case "boolean":
			...
			$objeto = "
				<br><select class=' nminputselect_boolean ' name='i".$reg{'idcampo'}."' id='i".$reg{'idcampo'}."' onchange='campo_onchange(this,true)' ".$deshabilitado." >
		...
		case "datetime_seg_hr":	
			...
			if($a==0){
				...
				//error_log("hora almacenada:".$reg_m[$reg{'nombrecampo'}]);
				if($reg_m[$reg{'nombrecampo'}]!="0000-00-00 00:00:00"){
					$fecha_m = strtotime($reg_m[$reg{'nombrecampo'}]);
					$dia = date("d",$fecha_m);
					$mes = date("m",$fecha_m);

<?php
	...
	while($reg = $conexion->siguiente($result)){					
		...
		// CONSTRUYENDO EL FORMULARIO
                        ...
                        if(!$quitarcampo){
                        	...
                        	//error_log(" columna:".$catalog_columna." usuario:".$reg{'nombrecampo'});
                            ...
                            if($catalog_columna>$catalog_columnas){
                                    ...
                                    //$captura.="</tr>";
                                    $captura.="</div>";
                                    //$captura.="<tr last_class=' nmcataloglistadofila ' title='".$reg{'descripcion'}."' valign='middle' >";
                            ...
                            /*$captura.="
                                <td last_class='campo'>                            		
                            		<label id='lbl".$reg{'idcampo'}."'>
                                	".$reg{'nombrecampousuario'}.": </label>
                                	<label style='color:#FF0000; font-weight:bold;'>".$requerido."</label><br>
	...
	//echo implode(",",$_SESSION['controles']->getcampos());
	...
	<head>						
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				$('#secundariolog').on('hidden.bs.modal', function () {
					btn_cerrar_secundariolog_click();
				});				
	...
	<body onload="loadbody()">
		...
		<script>
			...
			function btn_cerrar_secundariolog_click(){
				...
				//alert(url_q);
				$("#"+div_secundariolog).load(url_q, function (){
					$('.nminputselect').select2({
	                	language: "es",
	                	width: "100%"
	                });
				...
				$("#secundariolog").modal('hide');
			}

		</script>
		
		<div class="modal fade in" id="secundariolog" tabindex="-1" role="dialog">
			<div class="modal-dialog" role="document">
			<div class="modal-content">
      			<div class="modal-header">
        			<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        			<h5 class="modal-title" id='secundariolog_lbl_title'>---</h5>
      			</div>
				<div class="modal-body" style="padding:0px;">		
					<iframe scroll="none" id="frsecundariolog"></iframe>
					<div id="div_wait_secundariolog">
				...
				<div class="modal-footer">
					<button id="btn_cerrar_secundariolog" data-dismiss="modal"
		...
		<form id="frm" enctype="multipart/form-data" action="fg.php" method="post" onSubmit="return valida();">
			...
			<!-- <table border="0" class="nmcatalogtable table" cellpadding="3" cellspacing="0">-->
				<!-- CAMPOS -->
				<?php echo $captura; ?>
			<!-- </table>-->	

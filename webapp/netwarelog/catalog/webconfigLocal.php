<?php
	...
	$servidor   	= "localhost"; 	//servidor:puerto --- 3306
	
	$usuariobd  	= "root";				//Usuario para conectarse a MySQL
	
	$clavebd    	= "alexismax"; //"alexismax";				//Clave del usuario anterior
	
	$bd		= "nmimk";		//Nombre de la base de datos: netwaremonitor cambielo por el nombre real.

		...
		*/
		...
		$script_detalles_dependenciacompuesta.= " 												 
						 ...
						 //if((".$script_detalles_dependenciastodo."sidcampo==\"iniciando\")&&(!cargandofilasiniciales)){							 
							  ...
							  var ic=\"".$rsd{'idcampo'}."_\"+filaactual;		
							  var cv=\"".$campovalor."\";
							  var cd=\"".$campodesc."\";
							  ...
							  var fo=\"".$rsd{'formato'}."\";
							  var fa=filaactual; //enviando fila actual
							  ...
							  if(sidcampo!=\"".$rsd{'idcampo'}."_\"+fa){
									  ...
									  $(\"#divi".$rsd{'idcampo'}."_\"+fa).load(a,function(response,status,xhr){								
										
										//Aqui esta la falla se vuelve recursivo necesito una condición de paro...
										campo_onchange(document.getElementById('i".$rsd{'idcampo'}."_'+fa),true);
										
										//dependenciascompuestas('".$rsd{'idcampo'}."');
										//alert('entre a dependencia compuesta me llamo:'+idcampo+' y yo soy:".$rsd{'nombrecampo'}."');
										//document.getElementById('txtesperarcompuesta').value = 0;
										/*
										document.getElementById('divdepurar').innerHTML = 		
												document.getElementById('divdepurar').innerHTML + 
												' -- soy <b>".$rsd{'nombrecampo'}."</b> entre por:' + idcampo + 

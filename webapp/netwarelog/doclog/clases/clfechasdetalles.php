...
class fechasdetalles{
	...
	//$this->script_fechas="	-----script type='text/javascript'---- Calendar.setup({ inputField	 : '".$idcampo."_3',baseField    : '".$idcampo."',displayArea  : '".$idcampo."_area',button		 : '".$idcampo."_img',ifFormat	 : '%B %e, %Y',onSelect	 : selectDate }); -----/script----";

...
Calendar.cellClick = function(el, ev) {
	...
	if (newdate) {
		...
		//MODIFICADO POR OMAR MENDOZA PARA DEPENDENCIAS
		var p = cal.params;
		campo_onchange(p.inputField,true);
		/////////		
...
Calendar._TT["PREV_YEAR"] = "Año anterior (clic para lista)";
Calendar._TT["PREV_MONTH"] = "Mes anterior (clic para lista)";
Calendar._TT["GO_TODAY"] = "Día de hoy";
Calendar._TT["NEXT_MONTH"] = "Mes siguiente (clic para lista)";
Calendar._TT["NEXT_YEAR"] = "Año siguiente (clic para lista)";
Calendar._TT["SEL_DATE"] = "Seleccione una fecha";
Calendar._TT["DRAG_TO_MOVE"] = "Click para mover";
Calendar._TT["PART_TODAY"] = " (Ahora)";

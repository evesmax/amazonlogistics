...
<html lang="sp">
	...
	<body>
		...
		<a title="Nueva estructura" class="nuevo" href="estructura_form.php?idestructura=-1"><img class="btn" src="../img/nuevo.png"></a>
		<a title="Regresar al menú principal" class="regresar" target="_parent"  href="http://imkdh.intermerk.com.mx/Web"><img class="btn" alt="nuevo" src="../img/regresar.png"></a>
		</div>
						...
						<tr class="listadofila">
							<td>
								...
								<a class="campos" title="Editar campos"
									...
									<img class="btn" src="../img/campos.png">								
								</a>
								...
								<a class="activar" title="Activar estructura" 
									...
									<img class="btn" src="../img/activar.png">
								</a>
								...
								<a class="preliminar" title="Ver la captura en forma preliminar" 
									...
									<img class="btn" src="../img/preliminar.png">
								</a>

...
<html lang="en">
    ...
    <body>
        ...
        <!-- Modal para seleccionar Supervisores -->
        <div id="modal" class="modal fade" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title">Consultores</h4>
                    </div>
                    <div class="modal-body">
                        <table id="data_table_consultores" class="table table-striped table-bordered">
                            <thead>
                                <tr>
                                    <th>Consultor</th>
                                    <th>Seleccionar</th>
                            ...
                            <tbody id="data_table_body_consultores">
                            </tbody>
                        </table>
                    </div>
        ...
        <script src="js/organismo.js"></script>

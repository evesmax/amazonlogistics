        ...
        if($_GET['tipo'] == 'a29Txt')
         {
               ...
               echo "<tr><td style='font-weight:bold;font-size:14px;' colspan=5>A29 Proveedores</td></tr>";
                ...
                while(!feof($txt))
                {
                        $linea = fgets($txt);
                        $linea = explode('|',$linea);
                        echo "<tr><td>".$linea[0]."</td><td>".$linea[1]."</td><td>".$linea[2]."</td><td>".$linea[3]."</td><td>".$linea[4]."</td><td>".$linea[5]."</td><td>".$linea[6]."</td><td>".$linea[7]."</td><td>".$linea[8]."</td><td>".$linea[9]."</td><td>".$linea[10]."</td><td>".$linea[11]."</td><td>".$linea[12]."</td><td></td><td></td><td></td><td></td><td></td><td>".$linea[13]."</td><td>".$linea[14]."</td><td>".$linea[15]."</td><td></td></tr>";
                }
                fclose($txt);

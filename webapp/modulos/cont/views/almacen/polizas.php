    ...
    <div class="modal-content">
      ...
      <div class="modal-body well"><input type='hidden' id='id_poliza'>
              ...
              <div class="panel-body">
                ...
                <div class='row'>
                    <div class='col-xs-12 col-md-12'>
                    <div class='col-xs-12 col-md-6'>Segmento 
                      <img src='images/cuentas.png' onclick='irasegmentos()' title='Abrir Ventana de Segmentos' style='vertical-align:middle;'></div><div class='col-xs-12 col-md-6'>Sucursal <img src='images/cuentas.png' onclick='irasucursales()' title='Abrir Ventana de Sucursales' style='vertical-align:middle;'></div>
                    <div class='col-xs-12 col-md-6'>

						...
						<div class="col-md-12">
							<div class="table-responsive">
								<table id="datos" align="" cellpadding="2" border="0" class="table">
									...
									<tr>
									 ...
									 <tr>
									     ...
									     <td><?php 
											...
											<?php	} ?></td>
										<td align="center" width="3px;"><?php echo $this->datosFac($cli['xml']); ?></td> 
									     <td align="center" id="">
									  ...
									  <!-- retencion -->
									  <tr><td colspan="10" class="nmwatitles">Retencion</td></tr>
									...
									<?php	} ?> </td>
												<td align="" name="xml" id="xml" style="size: 10px"><?php echo $this->datosFac($prove['xml']); ?></td> 
												<td align="center" id="">
										     		<select name='segmento<?php echo $cont; ?>' id='segmento<?php echo $cont; ?>' style='width: 100px;text-overflow: ellipsis;'  class="nminputselect">
														<?php echo $segmento; ?>
													</select>

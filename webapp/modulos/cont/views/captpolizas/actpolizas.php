		...
		<div class="col-md-10 col-sm-10" id="c3">
			...
			<section>
				<div class="row">
					...
					<div class="col-md-3 col-sm-3 ">
						<div class="form-group">
							<input style="margin-top: 0.3em;" type='text' class="buscar_input form-control" id='buscar'  name='buscar' onkeydown="if (event.keyCode == 13) {return false;}" placeholder='Buscar'>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-md-12 col-sm-12">
						<div class="table-responsive">          
                            ...
                            <div id="info" style="display:none;margin-left:26.5%;"><b>Sumas: </b><input type="tex" id="data_cargos" style="width:18%;" readonly="true"> <input readonly="true" type="tex" id="data_abonos" style="width:18%;"></div>
			  			</div>
				  	</div>
				</div>

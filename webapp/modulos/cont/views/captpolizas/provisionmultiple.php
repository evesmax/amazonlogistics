									  				...
									  				<table class="table datos" id="tabla<?php echo $cont;?>" >
														...
														<tbody>
															<tr style="background-color:#BDBDBD;color:#585858;font-weight:bold;">
																<td align="center" width="3px;" colspan="2"><?php echo $this->datosFac($cli['xml']); ?><input type="hidden" id="hayProrrateo<?php echo $cont; ?>" value="0"/><!-- 0 no 1 si --></td> 
									  						...
									  						<tr class="out" onmouseout="this.className='out'" onmouseover="this.className='over'" class="porrateo" >
															    ...
															    <td align="center" id="">
                                                                    <!-- Ir a segmento -->
                                                                    <img style="vertical-align:middle;" title="Abrir Ventana de Cuentas" onclick="irasegmento()" src="images/cuentas.png">
                                                                    <!-- Ir a segmento -->
																    <img style="vertical-align:middle;" title="Actualizar Segmentos" onclick="actualizaSegmentos(<?php echo $cont ;?>)" src="images/reload.png">
															    ...
															    <td align="center" id="">
                                                                    <!--Ir a sucursal -->
                                                                    <img style="vertical-align:middle;" title="Abrir Ventana de Cuentas" onclick="irasucursal()" src="images/cuentas.png">
                                                                    <!--Actualizar sucursal -->
																    <img style="vertical-align:middle;" title="Actualizar sucursal" onclick="actualizaSucursal(<?php echo $cont ;?>)" src="images/reload.png">
															...
															<div class="col-md-12">
																<div class="table-responsive">          
													  				<table class="table datos" id="tabla<?php echo $cont;?>">
																		...
																		<tbody>
																		<tr style="background-color:#BDBDBD;color:#585858;font-weight:bold;">
																		<td align="center" width="3px;" colspan="2"><?php echo $this->datosFac($cli['xml']); ?>
																...
																<div class="col-md-12">
																	<div class="table-responsive">          
														  				<table class="table" id="tabla<?php echo $cont;?>" >
																						...
																						<tbody>
																						<tr style="background-color:#BDBDBD;color:#585858;font-weight:bold;">
																							<td align="center" width="3px;" colspan="2"><?php echo $this->datosFac($prove['xml']); ?>
																								<input type="hidden" id="hayProrrateo<?php echo $cont; ?>" value="0"/><!-- 0 no 1 si -->
																							</td> 

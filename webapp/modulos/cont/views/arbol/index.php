	...
	<div class="container">
		<section>
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<label>&nbsp;</label>
					<a role='button' href="index.php?c=reports&f=catalogoCuentas" class="btn btn-primary btnMenu">Reporte de catálogo de cuentas</a>
				</div>
			</div>
		</section>
		<section>
...
<div class="modal fade bs-cuentatitulo-modal-sm" tabindex="-1" role="dialog" aria-labelledby="cuentatitulo">
  <div class="modal-dialog modal-sm">
	<div class="modal-content">
	  <div class="modal-header panel-heading" style='background-color:#337ab7;color:#FFFFFF;'>
				<b>Habilitar cuentas de titulo</b>
			</div>
		<div class="modal-body well">
				<div class='col-xs-12 col-md-6'>Habilitar?</div>
				<?php
					$checkit = '';
					if($habilitado)
						$checkit = 'checked';
				?>
				<div class='col-xs-12 col-md-6'><input type='checkbox' id='habilitar' <?php echo $checkit;?>></div>
		</div>
			<div class="modal-footer">
				<button id='guardar_hc' class='btn btn-default btn-sm' onclick='habilitar()'>Generar</button>
				<button class='btn btn-default btn-sm' onclick="$('.bs-cuentatitulo-modal-sm').modal('hide');">Cerrar</button>
			</div>      
	</div>
  </div>
</div>

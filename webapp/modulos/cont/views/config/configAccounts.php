...
<div class="container well">
    ...
    <div class="row">
        <ul class="nav nav-tabs" id="myTab">
            <li class="active" ><a data-toggle="tab" href="#paso2" >Cuentas de Mayor</a></li>
            <li><a data-toggle="tab" href="#paso3">Cuentas Contables</a></li>
            <li><a data-toggle="tab" href="#paso4">Concepto de Nómina</a></li>
        </ul>
        <form name='newCompany' method='post' action='index.php?c=Config&f=saveConfigAccounts' onsubmit='return valida(this)' class="form-horizontal">
        <div class="tab-content" style="min-height:350px;">
            <div id="paso2" class="tab-pane fade in active">
                <div class="panel panel-default">
                    <div class="panel-heading">                                            
                        <h3 class="panel-title">Selecciona la Cuenta de Mayor</h3>
                    </div>
                            ...
                            <section>
                                    ...
                                    <div class="col-md-12 col-sm-1">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-md-6">Cuenta de Caja:</label>
                                                <div class="col-md-6">
                                                    <button type='button' class="btn btn-primary btnMenu" id="showCaja" data-id='caja'>Asignar Cuenta</button>
                                                </div>
                                                <div class="col-md-6">
                                                    <div id="hidecaja">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-6">Cuenta de Bancos:</label>
                                                <div class="col-md-6">
                                                        <button type='button' class="btn btn-primary btnMenu" id="showBancos" data-id='bancos'>Asignar cuenta</button>
                                                    </div>
                                                <div class="col-md-6">
                                                        <div id="hidebancos">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-6">Cuenta de Clientes:</label>
                                                <div class="col-md-6">
                                                    <button type='button' class="btn btn-primary btnMenu" id="showClientes" data-id='clientes'>Asignar cuenta</button>
                                                </div>
                                                <div class="col-md-6">
                                                    <div id="hideclientes">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-md-4">Cuenta de Gastos</label>
                                                <div class="col-md-6">
                                                    <button type='button' class="btn btn-primary btnMenu" id="showCuentasgastospolizas" data-id="Cuentasgastospolizas">Asignar Cuenta</button>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4">Utilidad Cambiaria:</label>
                                                <div class="col-md-6">
                                                    <button type='button' class="btn btn-primary btnMenu" id="showUtilidad" data-id="utilidad">Asignar Cuenta</button>
                                                </div>
                                                <div class="col-md-6">
                                                    <div id="hideutilidad">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-4">Perdida Cambiaria:</label>
                                                <div class="col-md-6">
                                                    <button type='button' class="btn btn-primary btnMenu" id="showPerdida" data-id="perdida">Asignar Cuenta</button>
                                                </div>
                                                <div class="col-md-6">
                                                    <div id="hideperdida">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-1">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-md-6">Cuenta Deudores Diversos:</label>
                                                <div class="col-md-6">
                                                    <button type='button' class="btn btn-primary btnMenu" id="showDeudores"  data-id="deudores">Asignar Cuenta</button>
                                                </div>
                                                <div class="col-md-6">
                                                    <div id="hidedeudores">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-6">Cuenta de Proveedores:</label>
                                                <div class="col-md-6">
                                                    <button type='button' class="btn btn-primary btnMenu" id="showProveedores" data-id="proveedores">Asignar cuenta</button>
                                                </div>
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-6">Cuenta de Capital (Saldos ejercicios):</label>
                                                <div class="col-md-6">
                                                    <button type='button' class="btn btn-primary btnMenu" id="showCapital" data-id="capital">Asignar Cuenta</button>
                                                </div>
                                                <div class="col-md-6">
                                                    <div id="hidecapital">
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-6">Cuenta de Ingresos:</label>
                                                <div class="col-md-6">
                                                    <button type='button' class="btn btn-primary btnMenu" id="showCuentasgastospolizasingresos" data-id="Cuentasgastospolizasingresos">Asignar Cuenta</button>
                                                </div>
                                                <div class="col-md-6">
            ...
            <div id="paso3" class="tab-pane fade">                                            
                <div class="panel panel-default">
                    <div class="panel-heading">  
                        <h3 class="panel-title">Selecciona la Cuenta afectable</h3>
                    </div>
                    <div class="panel-body">
                            <section>
                                <!--<div class="row" style="display:none;">-->
                                <!--SE HABILITO CHECKBOX PARA LUIS-->
                                <div class="row">
                                    <div class="col-md-12">
                                        <h5>
                                            <div class="checkbox">
                                                <label style="padding-left: 0 !important; margin-left: 20px;">
                                                    <input type="checkbox" id="defaultimp" name="defaultimp" value="1" onclick="defaultimpuesto();" checked="true" />
                                ...
                                <div class="row" id="cuentaivaieps">
                                        ...
                                        <div class="row" id="calculaiva">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="col-md-6">IVA Acreditable Pagado:</label>
                                                            <div class="col-md-6">
                                                                <button type='button' class="btn btn-primary btnMenu" id="showIvapagado"  data-id="ivapagado">Asignar Cuenta</button>
                                                            </div>
                                                            <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-6">IVA Acreditable Pendiente de pago:</label>
                                                            <div class="col-md-6">
                                                                <button type='button' class="btn btn-primary btnMenu" id="showIvapendientepago"  data-id="ivapendientepago">Asignar Cuenta</button>
                                                            </div>
                                                            <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-6">IVA Trasladado Cobrado:</label>
                                                            <div class="col-md-6">
                                                                <button type='button' class="btn btn-primary btnMenu" id="showIvacobrado"  data-id="ivacobrado">Asignar Cuenta</button>
                                                            </div>
                                                            <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-6">IVA Trasladado Pendiente de cobro:</label>
                                                            <div class="col-md-6">
                                                                <button type='button' class="btn btn-primary btnMenu" id="showIvapendientecobro"  data-id="ivapendientecobro">Asignar Cuenta</button>
                                                            </div>
                                                            <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="col-md-4">ISH:</label>
                                                                <div class="col-md-6">
                                                                    <button type='button' class="btn btn-primary btnMenu" id="showIsh"  data-id="ish">Asignar Cuenta</button>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <div id="hideish">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-4">IVA Retenido:</label>
                                                                <div class="col-md-6">
                                                                    <button type='button' class="btn btn-primary btnMenu" id="showIvaretenido"  data-id="ivaretenido">Asignar Cuenta</button>
                                                                </div>
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-4">ISR Retenido:</label>
                                                                <div class="col-md-6">
                                                                    <button type='button' class="btn btn-primary btnMenu" id="showIsrretenido"  data-id="isrretenido">Asignar Cuenta</button>
                                                                </div>
                                                                <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-md-4">Sueldo por Pagar:</label>
                                                                <div class="col-md-6">
                                ...
                                <div class="row" id="calculaieps">
                                    <div class="col-md-12 col-sm-1">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="col-md-6">IEPS Acreditable Pagado:</label>
                                                    <div class="col-md-6">
                                                        <button type='button' class="btn btn-primary btnMenu" id="showIepspagado"  data-id="iepspagado">Asignar Cuenta</button>
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-6">IEPS Acreditable Pendiente de pago:</label>
                                                    <div class="col-md-6">
                                                        <button type='button' class="btn btn-primary btnMenu" id="showIepspendientepago"  data-id="iepspendientepago">Asignar Cuenta</button>
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-6">IEPS Trasladado Cobrado:</label>
                                                    <div class="col-md-6">
                                                        <button type='button' class="btn btn-primary btnMenu" id="showIepscobrado"  data-id="iepscobrado">Asignar Cuenta</button>
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-6">IEPS Trasladado Pendiente de cobro:</label>
                                                    <div class="col-md-6">
                                                        <button type='button' class="btn btn-primary btnMenu" id="showIepspendientecobro"  data-id="iepspendientecobro">Asignar Cuenta</button>
                                                    </div>
                                                    <div class="col-md-6">
                                ...
                                <div class="row" style="display:none;">
                                    <div class="col-md-12">
                                        <h5>
                                            <div class="checkbox">
                                                <label style="padding-left: 0 !important; margin-left: 20px;">
                                                    <input type="checkbox" id="defaultieps" name="defaultieps" value="1" onclick="defaultiepscuenta();" checked="true" />
                                                    Calcula IEPS
                                              </label>
                                            </div>
                                        </h5>
                                ...
                                <div class="row" style="display:none;">
                                    <div class="col-md-12">
                                        <h5>
                                            <div class="checkbox">
                                                <label style="padding-left: 0 !important; margin-left: 20px;">
                                                    <input type="checkbox" id="retencion" name="retencion" value="1" onclick="retenshowhide();" checked="true" />
            ...
            <div id="paso4" class="tab-pane fade">
                <div class="panel panel-default">
                    <div class="panel-heading">  
                        <h3 class="panel-title">Agregar las Cuentas Afectables</h3>
                    </div>
                    <div class="panel-body">
                            <section>
                                <div class="row fila-base">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select name="cuentapercepcion[]" id="cuentapercepcion"  onchange="validaPercep(this.value)" class="" style="margin-left:30%;">
                                                <?php echo $listaCuentaDeduccionesPercepciones; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-2" style="margin-left:20%; margin-top:-1%;width:11%;">
                                        <div class="form-group">
                                            <button type='button' class="btn btn-danger btnMenu eliminar"><span class="glyphicon glyphicon-remove"></span></button>
                                        </div>
                                    </div>
                                </div>
                                <div class="row fila-base2">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select name="deducciones[]" id="deducciones" onchange="" class="">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select name="cuentadeducciones[]" id="cuentadeducciones" class="s2" onchange="validaDeducci(this.value)" style="margin-left:30%;">
                                                <?php echo $listaCuentaDeduccionesPercepciones; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-2" style="margin-left:20%; margin-top:-1%; width:11%;">
                                        <div class="form-group">
                                            <button type='button' class="btn btn-danger btnMenu eliminar2"><span class="glyphicon glyphicon-remove"></span></button>
                                        </div>
                                    </div>
                                </div>
                                <div class="row fila-base3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <select name="cuentaotrospagos[]" id="cuentaotrospagos"  onchange="validaotrospagos(this.value)" class="" style="margin-left:30%;">
                                                <?php echo $listaCuentaDeduccionesPercepciones; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-2" style="margin-left:20%; margin-top:-1%;width:11%;">
                                        <div class="form-group">
                                            <button type='button' class="btn btn-danger btnMenu eliminar3"><span class="glyphicon glyphicon-remove"></span></button>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <input type="button" id="agregar" value="Agregar PERCEPCIONES" class="btn btn-primary btnMenu"/>
                                        <input type="button" id="agregardefault" value="Agregar" style="display: none" class="btn btn-primary btnMenu"/>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="button" id="agregar2" value="Agregar DEDUCIONES" class="btn btn-primary btnMenu"/>
                                        <input type="button" id="agregardefault2" value="Agregar" style="display: none" class="btn btn-primary btnMenu"/>
                                    </div>
                                    <div class="col-md-4">
                                        <input type="button" id="agregar3" value="Agregar OTROS PAGOS" class="btn btn-primary btnMenu"/>
                                ...
                                <div class="row filadefault3" style="margin-left:5%;">
                                    <div class="col-md-5">
                                        <div class="form-group">
		...
		// Inicia seccion de asignacion de valores iniciales
			/*jshint ignore:start*/
				<?php
					...
					$datos .= ( $data['statusIVA'] !=0 ) ? " $( '#defaultiva ').prop('checked',true); " : "";
					$datos .= ( $data['statusIVA'] ==0 ) ? "  $( '#defaultiva ').prop('checked',false);" : "";
			...
			echo $datos;
					...
					while ($p = $creadasPercepciones->fetch_assoc()){
						...
						arrayCuentaPercepcion.push(".$d['account_id'].");
							...
							$('.filadefault #nombrep').html('".$p['descripcion']."');
							$('.filadefault #cuentap').html('".$p['description']."'); 
					...
					while ($d = $creadasDeducciones->fetch_assoc()){
						...
						$('.filadefault2 #nombred').html('".$d['descripcion']."');
						$('.filadefault2 #cuentad').html('".$d['description']."');
					...
					while ($o = $creadasOtros->fetch_assoc()){
						...
						$('.filadefault3 #nombreo').html('".$o['descripcion']."');
						$('.filadefault3 #cuentao').html('".$o['description']."');
...
<?php  } ?>
		...
		// Inicia seccion de control de botones de modificacion
			 ...
			 $("select.s2").each(function(){
				...
				{
                    var array_id =["compras","ventas","devoluciones","clientes","IVA","caja","TR","bancos","capital","flujo","proveedores","utilidad","perdida","ivapendientepago","ivapagado","ivapendientecobro","ivacobrado","iepspendientepago","iepspagado","iepspendientecobro","iepscobrado","deudores", "Cuentasgastospolizas", "Cuentasgastospolizasingresos", "ish", "isrretenido", "ivaretenido", "iepsgasto", "sueldo", "ivagasto"];;
					
                   for(var x = 0; x < array_id.length; x ++){
                       $("#"+array_id[x]).select2({"width":"300px"});
                       $("#s2id_"+array_id[x]).attr({"data-toggle":"tooltip","placement":"top","title":$('#s2id_'+array_id[x]).text()});
                   } 

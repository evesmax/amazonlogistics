            ...
            <div class="panel panel-default">
              ...
              <div class="col-xs-12 col-md-12 table-responsive">
                  ...
                  <table id="tabla-prof" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                      <thead>
                          <tr><th>Id</th><th>Razon Social</th><th>Nombre</th><th>Correo</th><th>Telefono</th><th>Giro</th><th>Instancia</th><th>Usuario Master</th><th>Password Master</th><th></th></tr>
                      </thead>
                      <tbody id='trs_prof'>
                      </tbody>
                  </table>
              ...
              <div class="panel-body">
                  <div class="col-xs-12 col-md-12 table-responsive">
                    ...
                    <table id="tabla-grup" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                        <thead>
                            <tr><th>Id</th><th>Descripcion</th><th>Modificar</th><th>Eliminar</th></tr>
                        </thead>
                        <tbody id='trs_grup'>
                        </tbody>
                    </table>
              ...
              <div class="panel-body"> 
                    <div class="col-xs-12 col-md-12 table-responsive">
                      ...
                      <table id="tabla-alum" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                          <thead>
                              <tr><th>Id</th><th>Razon Social</th><th>Nombre</th><th>Correo</th><th>Telefono</th><th>Giro</th><th>Instancia</th><th>Usuario Master</th><th>Password Master</th><th>Profesor</th></tr>
                          </thead>
                          <tbody id='trs_alum'>
                          </tbody>
                      </table>
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                  <div class="col-xs-12 col-md-12 table-responsive">
                    ...
                    <div class='col-xs-12 col-md-3'>
                      <select id='grupos_rel' onchange='busca_relaciones()' class='form-control'>
                      </select>
                    </div>
                    <div id='boton_virtual3' class='col-xs-12 col-md-12'><button class='btn btn-primary btn-sm' data-toggle="modal" data-target=".bs-relaciones-modal-sm" onclick="nueva_relacion(0)">Nuevo <span class='glyphicon glyphicon-plus'></span></button></div>
                    <table id="tabla-rel" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                        <thead>
                            <tr><th>Id</th><th>Profesor</th><th>Alumno</th><th>Grupo</th><th>Eliminar</th></tr>
                        </thead>
                        <tbody id='trs_rel'>
                        </tbody>
                    </table>

...
((SELECT SUM(rp.importeBase * (SELECT valor FROM cont_tasaPrv WHERE id=rp.tasa)/100) FROM cont_rel_pol_prov rp WHERE rp.idPoliza = p.id AND rp.activo=1)-r.ivaRetenido) AS ImporteFiscal,

	...
	public function cuentas(){
	 ...
	 public function cuentas_mayor()
	 {
       ...
       '.', '') AS h2,
	 	...
	 	WHERE a.main_account = 1 AND a.removed=0 
	 ...
	 public function UpdateNif($IdCuenta,$Valor)
	 {
	 	$myQuery = "UPDATE cont_accounts SET nif = $Valor WHERE account_id = $IdCuenta";
	 	$this->query($myQuery);
	 }
}
?>

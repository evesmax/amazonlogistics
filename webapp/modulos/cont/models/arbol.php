...
*/
	 ...
	 {
	 	return $this->query("UPDATE cont_config SET hab_cta_titulo = $si WHERE id = 1");
	 }

	 function titulo()
	 {
	 	$res = $this->query("SELECT hab_cta_titulo FROM cont_config WHERE id = 1");
	 	$res = $res->fetch_assoc();
	 	return intval($res['hab_cta_titulo']);
	 }

	 public function gethabilitado()
	 {
	 	$result = $this->query('SELECT hab_cta_titulo FROM cont_config WHERE id=1');
	 	$result = $result->fetch_object();
		return intval($result->hab_cta_titulo);
	 }

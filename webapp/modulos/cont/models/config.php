...
require("models/connection_sqli_manual.php"); // funciones mySQLi
	...
	class ConfigModel extends Connection
	{
		...
		function saveConfig($act,$IdCompany,$default_catalog,$structure,$values,$level,$numpol,$rfc,$begin,$period,$periods,$current_period,$open_periods,$primera_vez,$cl_num,$tipoinstancia,$todas_facturas,$confirmar_poliza, $siete_dimensiones, $usabancos)
		{	
...
GROUP BY idLin";
		...
		function CuentaGasto(){//resultado deudoras aplica tambien para percepciones de nomina
			$sql=$this->query("select * from cont_accounts where affectable=1 ");
			return $sql;
		...
		function deduccionesNomina(){
			...
			$sql=$this->query("SELECT * FROM nomi_deducciones WHERE activo = 1");
			return $sql;
		}

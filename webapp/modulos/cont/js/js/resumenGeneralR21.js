function reporte_post(){
	...
	if($error===0){
		if($toexcel==1){
			$url = 'ajax.php?c=resumenGeneralR21&f=reporte&ejercicio='+$ejercicio+'&per_ini='+$per_ini+'&per_fin='+$per_fin+'&to_excel='+$toexcel+'&tasa_sel='+$tasa_sel+'&sel_rep='+$sel_rep+'&prop='+$prop+'&use_prop='+$use_prop+'&acr_iva='+$acr_iva;
			window.open($url,'_blank');
		}
		else{
		
			window.location='ajax.php?c=resumenGeneralR21&f=reporte&ejercicio='+$ejercicio+'&per_ini='+$per_ini+'&per_fin='+$per_fin+'&to_excel=0&tasa_sel='+$tasa_sel+'&sel_rep='+$sel_rep+'&prop='+$prop+'&use_prop='+$use_prop+'&acr_iva='+$acr_iva;

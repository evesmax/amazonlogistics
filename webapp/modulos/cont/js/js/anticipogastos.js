$(document).ready(function(){
 ...
 function deudoranticipo(){ $("#load3").show();
...
$("#capturaNoDeducible").dialog({
	autoOpen: false,
	modal: true,
	buttons: {
		"Agregar No Deducible": function () {
...
$("#capturaNoDeducible").dialog("option", "width", 550);
$("#capturaNoDeducible").dialog("option", "height", 270);
$("#capturaNoDeducible").dialog("option", "resizable", false);
$("#capturaNoDeducible").dialog("open");

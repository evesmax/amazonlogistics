...
function irasegmentos(){
	window.parent.agregatab('../catalog/gestor.php?idestructura=251&ticket=testing','Segmentos','',1656)
}

function irasucursales(){
	window.parent.agregatab('../catalog/gestor.php?idestructura=86&ticket=testing','Sucursales','',2152)
}

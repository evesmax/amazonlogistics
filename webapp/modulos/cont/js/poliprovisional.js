...
function irasucursal(){
	window.parent.agregatab('../../netwarelog/catalog/gestor.php?idestructura=280&ticket=testing','Cuentas Bancarias','',1804);
	//window.location='../../modulos/cont/index.php?c=AccountsTree';
}
function irasegmento(){
	window.parent.agregatab('../../netwarelog/catalog/gestor.php?idestructura=251&ticket=testing','Segmentos de negocio','',1656);
	//window.location='../../modulos/cont/index.php?c=AccountsTree';
}
...
function actualizaSegmentos(cont){
    $('#cargando-mensaje').css('display','inline');
	$.post("ajax.php?c=CaptPolizas&f=actualizasegmentos",
           function(datos){
                $('#segmento'+cont).html(datos);
				$("#segmento"+cont).select2({
				    width : "100px"
				});
                $('#cargando-mensaje').css('display','none');
            });
}
function actualizaSucursal(cont){
    $('#cargando-mensaje').css('display','inline');
	$.post("ajax.php?c=CaptPolizas&f=actualizasucursal",
           function(datos){
                $('#sucursal'+cont).html(datos);
				$("#sucursal"+cont).select2({
				    width : "100px"
				});
                $('#cargando-mensaje').css('display','none');
            });

...
$resultado = $conexion->consultar($sqllimpia);
	...
	//Referencia Deposito
	$sqlref="(SELECT a.consecutivo FROM ventas_saldosclientes a 
                LEFT JOIN ventas_saldosclientes_detalle b ON a.idsaldocliente=b.idsaldocliente
                WHERE doctoorigen=8 AND foliodoctoorigen=oc.idordencompra limit 1)"; 
	...
	$sqlresumen="Select loe.fecha, coe.oe,loe.referencia2 ie,of.nombrefabricante ingenio, 
				...
				,ie.descripcionestado calidad, tim.tipomercado, vsm.segmentomercado, cn.norma, oc.clavecontrato, oc.costo, $sqlref consecutivo  
                ,oc.idfabricante, oc.idmarca, oc.idbodega, oc.idloteproducto, oc.idproducto, oc.idestadoproducto
        ...
        $sqlresumen="Select c.fechacancelacion, c.oecancelacion,0 ie,of.nombrefabricante ingenio, 
					...
					(case when ob.tipobodega=-1 then 0 else $gastoglogistica end) importeglogistica,
									...
									,'' fechapago
									,ie.descripcionestado calidad, tim.tipomercado, vsm.segmentomercado, cn.norma, oc.clavecontrato, oc.costo, '-' consecutivo
                                    ,oc.idfabricante, oc.idmarca, oc.idbodega, oc.idloteproducto, oc.idproducto, oc.idestadoproducto
									from ventas_ordenesdecompra oc
                                            left join ventas_clientes cli on cli.idcliente=oc.idcliente
                                            left join operaciones_fabricantes of on of.idfabricante=oc.idfabricante
...
// Totales
                ...
                $ctotales=array("mostrar","decimales","valordefecto");
                    ...
                    //Totales
                        $ctotales["mostrar"][15]=1;
                        $ctotales["decimales"][15]=3;
                        $ctotales["valordefecto"][15]="";

                        $ctotales["mostrar"][16]=1;
                        $ctotales["decimales"][16]=2;
                        $ctotales["valordefecto"][16]="";   

			...
			<div class="row">
				<div class="col-md-10 col-md-offset-1">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-3">
							<label>&nbsp;</label>
							<input type="button" value="Ver movimientos" onClick="Vermovimientos();" class="btn btn-primary btnMenu">
						</div>
					...
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12 tablaResponsiva">
							<div class="table-responsive" id="movimientos" style="border: 1px solid black; margin-bottom: 5em;">
							</div>
						</div>
					</div>
				</div>

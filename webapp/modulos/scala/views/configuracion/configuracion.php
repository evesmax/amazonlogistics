                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div style="heigth:400px;overflow:auto;">
                            ...
                            <div class="tab-content" style="min-height:600px; border:1px solid black;">
                                ...
                                <div id="paso1" class="tab-pane fade in active">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                            <button type="button" class="btn btn-danger" onclick="deletepaso(1);">
                                                <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
                                            </button>
                                        </div>
                                        <div style="float:right; padding-right: 111px;">
                                            <img id="imglogo1" src="" width="150" height="150" alt="">
                                        </div>                                        
                                    </div><br><br>          
                                    <div class="form-group">
                                    ...
                                    <div class="form-group pull-right">
                                        <label id="lblogo1"></label>                                        
                                        <input type="file" id="filelogo1" size="100" name="Filedata" style="display: block;">
                                ...
                                <div id="paso2" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                            <button type="button" class="btn btn-danger" onclick="deletepaso(2);">
                                                <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
                                            </button>
                                        </div>
                                        <div style="float:right; padding-right: 111px;">
                                            <img id="imglogo2" src="" width="150" height="150" alt="">
                                        </div>
                                    </div><br><br>          
                                    <div class="form-group">
                                        <label class="control-label col-md-1">Descripcción</label>
                                    ...
                                    <div class="form-group pull-right">
                                        <label id="lblogo2"></label>                                        
                                        <input type="file" id="filelogo2" size="100" name="Filedata" style="display: block;">
                                ...
                                <div id="paso3" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                            <button type="button" class="btn btn-danger" onclick="deletepaso(3);">
                                                <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
                                            </button>
                                        </div>
                                        <div style="float:right; padding-right: 111px;">
                                            <img id="imglogo3" src="" width="150" height="150" alt="">
                                        </div>
                                    </div><br><br>          
                                    <div class="form-group">
                                        <label class="control-label col-md-1">Descripcción</label>
                                    ...
                                    <div class="form-group pull-right">
                                        <label id="lblogo3"></label>                                        
                                        <input type="file" id="filelogo3" size="100" name="Filedata" style="display: block;">
                                ...
                                <div id="paso4" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                            <button type="button" class="btn btn-danger" onclick="deletepaso(4);">
                                                <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
                                            </button>
                                        </div>
                                        <div style="float:right; padding-right: 111px;">
                                            <img id="imglogo4" src="" width="150" height="150" alt="">
                                        </div>
                                    </div><br><br>          
                                    <div class="form-group">
                                        <label class="control-label col-md-1">Descripcción</label>
                                    ...
                                    <div class="form-group pull-right">
                                        <label id="lblogo4"></label>                                        
                                        <input type="file" id="filelogo4" size="100" name="Filedata" style="display: block;">
                                ...
                                <div id="paso5" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-1">
                                            <button type="button" class="btn btn-danger" onclick="deletepaso(5);">
                                                <span class="glyphicon glyphicon-remove" aria-hidden="true"></span>
                                            </button>
                                        </div>
                                        <div style="float:right; padding-right: 111px;">
                                            <img id="imglogo5" src="" width="150" height="150" alt="">
                                        </div>
                                    </div><br><br>          
                                    <div class="form-group">
                                        <label class="control-label col-md-1">Descripcción</label>
                                    ...
                                    <div class="form-group pull-right">
                                        <label id="lblogo5"></label>                                        
                                        <input type="file" id="filelogo5" size="100" name="Filedata" style="display: block;">
                ...
                <div class="modal-body form">
                    <form action="#" id="form_guia" class="form-horizontal">
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2 subpaso">Link Video</label>
                                <div class="col-md-9">
                                    <input id="linkAcV" class="form-control subpaso" type="text">
                                </div>
                            </div>

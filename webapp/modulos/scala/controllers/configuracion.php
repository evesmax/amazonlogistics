...
class Configuracion extends Common
{
	...
	function edit_pasos2(){
		$paso 		= $_POST['paso'];
		$logo 		= $_POST['logo'];		
		$id_app 	= $_POST['id_app'];
		$edit_pasos = $this->ConfiguracionModel->edit_pasos2($paso,$id_app,$logo);
		echo $edit_pasos;
	}
	function save_pasos(){
		$paso 		= $_POST['paso'];
	...
	function save_actividad(){
		...
		$save_actividad = $this->ConfiguracionModel->save_actividad($nombre,$menu,$desc,$link,$linkV,$opcional,$estatus,$idpasoR);
		echo $save_actividad;
	...
	function edit_actividad(){
		...
		$idpasoR 	= $_POST['idpasoR'];
		$id_act 	= $_POST['id_act'];
		$edit_actividad = $this->ConfiguracionModel->edit_actividad($nombre,$menu,$desc,$link,$linkV,$opcional,$estatus,$idpasoR,$id_act);
		echo $edit_actividad;
	}
	...
	function deletepaso(){
		$idpasoR 	= $_POST['idpasoR'];
		$resp  = $this->ConfiguracionModel->deletepaso($idpasoR);

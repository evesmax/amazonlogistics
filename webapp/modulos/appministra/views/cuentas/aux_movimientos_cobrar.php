...
<script type="text/javascript" charset="utf-8">
    ...
    {
        $("#listaClientes,#formaPago").select2({'width':'100%'});
    ...
    var rango = $("#rango").prop('checked') ? 1 : 0;
        ...
        if(sigue)
        {
           $("#resultados").show();
            ...
            $.post('ajax.php?c=reportes_cuentas&f=aux_movimientos_cxc_reporte', 
            {
...
<div class="container well">
    <div class="row">
        <div class="col-xs-12 col-md-12"><h3>Auxiliar de Movimientos Cuentas por Cobrar</h3></div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-xs-12 col-md-12 table-responsive">
            <table class="table table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr><th>Fecha Documento</th><th>Folio</th><th>Concepto</th><th>Cargos</th><th>Abonos</th><th>Saldo</th><th>Fecha Vencimiento</th></tr>
                </thead>
                <tbody id='res_rep'>

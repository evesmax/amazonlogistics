    ...
    var rango = $("#rango").prop('checked') ? 1 : 0;
        ...
        if(sigue)
        {
           $("#resultados").show();
            ...
            $.post('ajax.php?c=reportes_cuentas&f=ant_saldos_reporte_cxc', 
            {
...
<div class="container well">
    <div class="row">
        <div class="col-xs-12 col-md-12"><h3>Antigüedad de saldos Clientes</h3></div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-xs-12 col-md-12 table-responsive">
            <table class="table table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr><th>Folio</th><th>Fecha Documento</th><th>Fecha Vencimiento</th><th>Dias Vencidos</th><th>Saldo</th><th>Sin vencer</th><th>1-15 días</th><th>16-30 días</th><th>31-45 días</th><th>+ de 45 días</th></tr>
                </thead>
                <tbody id='res_rep'>

...
<script type="text/javascript" charset="utf-8">
    ...
    {
      $.post('ajax.php?c=cuentas&f=pagos_detalle',
        {
            id : id,
            t  : t,
            cp : cp,
         ...
         function(data)
        {
            ...
            if($("td:nth-child(8)",b).text())
            {
              pendiente = $("td:nth-child(8)",b).text();
              pendiente2 = $("td:nth-child(8)",b).attr('cantidad');
            }
    ...
    {
      $("#rel_pago_det").attr('disabled',true)
...
if(!intval($_GET['cp']))
  ...
  $cxcp = "cuentasxpagar";
?>
    <div class="col-xs-12 col-md-2"><a class='btn btn-default' href='index.php?c=cuentas&f=<?php echo $cxcp;?>&id=<?php echo $datos_cli_prov['id_prov_cli'] ?>' role='button' ><span class='glyphicon glyphicon-arrow-left'></span> Regresar</a></div><div class="col-xs-12 col-md-10"></div>
  </div>
    <!-- Clientes -->
      ...
      <div class="modal-body well">
        ...
        <div class='row' id='forma_pago_div'>
          ...
          <div class='col-xs-2 col-md-2'>
            <button class='btn btn-success hidden2' onclick='verCamposCheqTrans(<?php echo $_GET['cp']; ?>,<?php echo $datos_cli_prov['id_prov_cli']; ?>)'>+</button>
          </div>
        </div> <!-- // Forma de pago -->
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body well">
        ...
        <!-- Modal footer -->
        <div class="modal-footer">
          <button id='rel_pago_det' class='btn btn-default btn-sm' onclick="rel_pago_det('<?php echo $_GET['cp'] ?>')">Guardar</button>

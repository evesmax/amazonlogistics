...
<script type="text/javascript" charset="utf-8">
    ...
    {
        $("#listaSucursales,#listaAlmacenes,#listatipo").select2({'width':'100%'});
        ...
        width:'100%',
        ajax: {
            url: 'ajax.php?c=inventarios&f=buscarProductos',
            type: 'GET',
            dataType: 'json',

            data: function(params) {
                return { 
                    opcion : $('#listaOpciones').val() ,
                    patron : params.term };
            },
                    ...
                    $.each(data, function(index, val) {
                        ...
                        if(val.aux == 'B'){
                            ...
                            x ='<tr>'+                                    
                                        ...
                                        '<td>'+FolioS+'</td>'+
                                        '<td align="right">'+( val.cliente !== null ? val.cliente : 'Publico General' )+'</td>'+
                                        '<td align="left">'+estado+'</td>'+
                                    '</tr>';  
                            table.row.add($(x)).draw(); 
                        }
                ...
                if(opc==4){
                    ...
                    var x ='';
                     $.each(data, function(index, val) {
                       if(val.aux == 'H'){
                            x ='<tr style="background-color:#d3d3d3">'+                                                                        
                                        '<td align="center" colspan = "9">'+val.almacen+'</td>'+
                                        '<td style="display: none;">'+
                                        '<td style="display: none;">'+
                                        '<td style="display: none;">'+
                                        '<td style="display: none;">'+
                        ...
                        if(val.aux == 'B'){
                            x ='<tr>'+
                                        '<td align="left">'+val.almacen+'</td>'+                           
                                        '<td align="left">'+val.codigo+'</td>'+
                                        '<td align="left">'+val.nombre+'</td>'+
                                        '<td align="left">'+val.unidad_compra+'</td>'+  
                                        '<td align="left">'+val.unidad_venta+'</td>'+  
...
<div class="container well col-sm-12">
    <div class="row">
        <div class="col-sm-12"><h3>Reporte de Series, Lotes y Productos caducos</h3></div>
    </div>
                ...
                <div class="col-sm-3 col-xs-3">
                   ...
                   <!--  <input type='text' id='f_ini' class='form-control'> -->
                        <div id="datetimepicker1" class="input-group date">
                            ...
                            <input id="f_ini" class="form-control" placeholder="Fecha de Entrega" type="text">
                        </div>
                </div>
                <div class="col-sm-3 col-xs-3">
                    <label>Hasta</label>
                    <!--<input type='text' id='f_fin' class='form-control'> -->
                        <div id="datetimepicker2" class="input-group date">
                            ...
                            <input id="f_fin" class="form-control" placeholder="Fecha de Entrega" type="text">
                        </div>
                </div>
                <div class="col-sm-3 col-xs-3">
        ...
        <div class="panel-body">
            <div class="col-sm-12">
                <div class="row">
                    ...
                    <div class="col-sm-12" id="divlotped">
                        <div>
                    ...
                    <div class="col-sm-12" id="divcaducos" style="overflow-x: scroll;">
                        <div>
                            <table id="table_caducos" class="table table-striped table-bordered" cellspacing="0" width="100%" >
                                        <thead>
                                          <tr>
                                            <th td width="25">Almacén</th>
                                            <th td width="25">Código</th>
                                            <th td width="25">Producto</th>
                                            <th td width="25">Unidad compra</th>
                                            <th td width="25">Unidad venta</th>
                                            <th td width="25">Lote</th>
                                            <th td width="25">Fabricacion</th>
                                            <th td width="25">Caducidad</th>
                                            <th td width="25">Existencia</th>
                                          </tr>
                                        </thead>

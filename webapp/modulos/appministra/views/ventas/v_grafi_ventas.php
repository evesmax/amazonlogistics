        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    ...
                    <input style="cursor:pointer;" type="radio" name="rep" id="R1unidades" value="2" > Importe ventas<br>
...
<div id="grafica" class="container" style="padding:0;display:none;">
    <div class="panel panel-default">
        <div class="panel-body" style="font-size:13px;">
            <div class="row"><span class="col-sm-12"><b>Reporte grafico de ventas</b></span></div>
            <div class="row"><span id="titreporte" class="col-sm-12">Los 5 productos mas vendidos</span><br></div>
            <div class="row">&nbsp;</div>
...
<script>
    ...
    function generarReporte(){
        ...
        $.ajax({
            url:"ajax.php?c=reportes_ventas&f=a_reporte",
            type: 'POST',
            dataType: 'JSON',
            data:{
                desde:desde,
            ...
            success: function(r){
                if(r.success==1){
                    $('#chart-bar').html('');
                    if(ordenar=='1'){
                        msgtitr='Los 5 productos mas vendidos';
                    }
                    if(ordenar=='2'){
                        msgtitr='Los 5 productos menos vendidos';
                    }

                    if(radio=='1'){
                        vp='Unidades';
                        txtlabel='Cantidad vendidos ';
                    }
                    if(radio=='2'){
                        vp='Importes';
                        txtlabel='Importe vendido $';
                    }

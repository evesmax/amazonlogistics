...
<body>
    ...
    <div class="container well" style="padding:25px;margin-bottom: 150px;">
        <div class="row" style="padding-bottom:20px;">
            <div class="col-xs-12 col-md-12" style="padding:0px 0px 0px 3px;"><h3>Catalogo de etiquetas</h3></div>
   ...
   <input type="hidden"  id="orden" value="" />
        ...
        <div class="row" style="margin-bottom:10px;">
            <button class="btn btn-default" type="button" onclick="nreq();">Nueva etiqueta</button>
            <button id="btnlistorden" class="btn btn-default" type="submit" onclick="listareq();">Listado etiquetas</button>
  ...
  error: function(jqXHR, textStatus, errorThrown) {
     console.log(jqXHR);
        ...
        <div id="nreq" class="row" style="display:none;">
            <div class="panel panel-default">
                <div id="ph"  class="panel-heading"><span opt="1" class="label label-primary" style="cursor:pointer;">Nueva Etiqueta</span></div>
                <div class="panel-body" style="padding:15px 0 10px 0; font-size:12px;">
                    <div class="col-sm-12">
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="color:#096;">
                            <input style="width: 400px;" type='text' id="neti" value='' class="form-control" placeholder="Escriba el nombre de la etiqueta">
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        -->
                            ...
                            <button id="btn_savequit_usar" class="btn btn-sm btn-primary pull-center" type="button" style="height:28px;">Utilizar inusmos existentes</button>
    
                            <button id="btn_savequit" class="btn btn-sm btn-success pull-center" type="button" style="height:28px;">Generar Etiqueta</button>
...
var today = yyyy+'/'+mm+'/'+dd;
        ...
        $("#btn_imprimir").click(function() {
            ...
            if(deten==1){
                enabled_btn('#btn_savequit','Generar Etiqueta');
                return false;
            }
...
$("#btn_savequit_usar").click(function() {
    ...
    $.ajax({
        ...
        $("#btn_savequit").click(function() {
            ...
            if(nombre==''){
                alert('Escriba un nombre para la etiqueta');
                return false;
            }
            ...
            if(idsProductos==''){
                alert('No hay tipo de etiquetas seleccionadas');
                enabled_btn('#btn_savequit','Generar Etiqueta');
                return false;
            }else{
                disabled_btn('#btn_savequit','Procesando...');
                console.log(idsProductos);
                $.ajax({
                    url:"ajax.php?c=produccion&f=a_guardarEtiqueta",
                    type: 'POST',
                    data:{
                        idsProductos:idsProductos,
                        option:option,
...
function elimiarEti(id){
    $.ajax({
        url:"ajax.php?c=produccion&f=a_eliminaEtiqueta",
        type: 'POST',
        dataType:'JSON',
        data:{id:id},
        success: function(r){
            ...
            $.ajax({
                ...
                success: function(r){
                    if(r.success==1){
                        ...
                        $('#ph').html('<span opt="1" class="label label-primary" style="cursor:pointer;">Nueva Etiqueta</span>');
                        $('#nreq').css('display','block');
                    }else{
...
$('#nreq_load').css('display','none');
    ...
    function verEti(idReq,mod){ 
        ...
        $('#btnback').css('visibility','visible');
            ...
            $.ajax({
                url:"ajax.php?c=produccion&f=a_editarEtiqueta",
                type: 'POST',
                dataType:'JSON',                                
                ...
                success: function(r){
                    ...
                    if(r.success==1){
                        ...
                        $('#neti').val(r.requisicion.nombre_etiqueta);
                        ...
                        $.each(r.productos, function( k, v ) {
                            ...
                            if(mod==0){
                                ...
                                txtdis='';
                                eliminProd="<button onclick='removeProdReq("+v.id_tipo+",0);' id='btn_addProd' class='btn btn-sm btn-danger' type='button' style='height:26px;'>Quitar</button>";
                                btndescPE='';
                            ...
                            Rowdata = "<tr ch='0' newp='0' oldp='0' tipoDesc='0' montoD='0' id='tr_"+v.id_tipo+"'><td>"+txtTipo+"</td><td><input style='width:60%;' class='numeros' readonly type='text' fact='2' min='2' value='"+v.digitos+"'/></td><td><button onclick='removeProdReq("+v.id_tipo+",0);' id='btn_addProd' class='btn btn-sm btn-danger' type='button' style='height:26px;'>Quitar</button></td></tr>";
        ...
        $('#btnback').css('visibility','hidden');
            ...
            language: {
                ...
                ajax: {
                    ...
                    url:"ajax.php?c=produccion&f=a_listaEtiquetas",
                    type: "POST",
                    data: function ( d )    {

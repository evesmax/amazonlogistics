    ...
    <div class="container well" style="padding:25px;">
        ...
        <div id="nreq" class="row" style="display:none;">
            <div class="panel panel-default">
                <div id="ph"  class="panel-heading"><span opt="1" class="label label-primary" style="cursor:pointer;">Nueva Requisicion</span></div>
                ...
                $.ajax({
                    ...
                    success: function(r){
                        ...
                        if(r>0){
                            ...
                            $.ajax({
                                url:"ajax.php?c=compras&f=a_checkNoti",
                                type: 'POST',
                                data:{
                                    idOc:r
                                },

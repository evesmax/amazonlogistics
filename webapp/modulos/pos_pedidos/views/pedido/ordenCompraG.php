                ...
                <div class="row">
                    <div class="col-sm-3" style="display: none;">
                        ...
                        <select id="tiporeporte" class="form-control" style="width: 100%;" >
                            <option value="1">Compras por empleado</option>  
                            <option value="2" selected="selected">Lista de compras generales</option>                     
                        </select>
                    </div>
                    ...
                    <div class="col-sm-3" id="opcion2" style="display: none;">
                ...
                <div id="infoOrdenCompra" class="row" style="display: none;">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12 text-right">
                            ...
                            <button id="btn_authquit_2" onclick="realizaOrdenes();" class="btn btn-sm btn-success pull-center" type="button" style="height:28px; ">Guardar Orden</button>
...
<script>
    ...
    */
    function listarCompra(desde,hasta,producto,cliente){
        ...
        $.ajax({ 
            url: 'ajax.php?c=caja&f=listarCompraG',
            type: 'post',
            dataType: 'json',
        ...
        .done(function(data) {  
            ...
            $.each(data.prod, function(index, val) {
                ...
                x ='<tr idproducto="'+idprod+'" cantidad="'+cantidadF+'" costo="'+costoCompra+'" ids="'+ids+'">'+
    ...
    */
    function realizaOrdenes(){
            ...
            tipo_compra=1; /// PARA NO HACER RECEPCION

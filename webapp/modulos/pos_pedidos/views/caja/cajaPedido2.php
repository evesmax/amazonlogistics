...
<div class="row" style="margin-top:-1%;">
	<div class="col-sm-7">
		<div class="row">
			...
			<!-- <div class="col-sm-1">
				<i class="fa fa-filter" aria-hidden="true" onclick="caja.toggleFilters();"></i>
			</div> -->
			<div class="col-sm-4">
	...
	<div class="col-sm-5">
		<div class="row">
			...
			<input type="hidden" id="idPedidox" value="<?php echo $idPedido; ?>">
...
<div class="row">
	...
	<div class="col-sm-7">
						...
						<div class="panel panel-default">
							...
							<div id="tab_insumos_preparados" class="" role="tabpanel" aria-labelledby="heading_insumos_preparados" >
	  ...
	  <div class="modal-content">
		...
		<div class="modal-body">
			...
			<div class="row"><div align="center"><label>Observaciones</label></div></div>
				    <div class="row">
                        <div class="col-md-12">
                            <textarea id="txtareaObservaciones" style="width:100%; resize:none" rows="5" class="form-control"><?php echo $prods['generales'][0]['observaciones'];  ?></textarea>
                        </div>
                    </div><br>

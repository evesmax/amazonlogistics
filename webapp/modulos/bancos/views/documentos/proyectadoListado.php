	...
	<script src="../../libraries/dataTable/js/dataTables.bootstrap.min.js" type="text/javascript"></script>
		<script src="../../libraries/export_print/jquery.dataTables.min.js" type="text/javascript"></script>
...
<!-- <label for="buscar">Buscar:</label> <input type="text" id="buscar" value=""/> -->  <br>
  	...
  	<?php if($ingresos){
  		...
  		<?php 	}
  			...
  			<tr>
  				<td colspan="8" align="center">No tiene Ingresos por Depositar</td>
  			</tr>
  	<?php } ?>
  		</tbody>
  	</table>
  	...
  	<script>
  		function editar(id){
  			window.location="index.php?c=Ingresos&f=verIngresoNodep&editar="+id;
  		}

	...
	<body>
		<div style="width:50%;background: #F2F2F2;" align="center" class="container well" >	
			<div class="panel panel-default" >
				<div class="panel-heading"  style="height: 46px"><b style="font-size: 16px;">Flujo de Efectivo</b></div> 
					<div class="panel-body" >	
						<form action="index.php?c=Flujo&f=reporteFlujo" id="filtro" method="post">
						<ul class="list-group" >
							...
							<li class="list-group-item">
								<input type="radio" value="1" name="tipo" checked=""/>Global
							</li>
							<!-- <li class="list-group-item">
							...
							<li class="list-group-item">
								<input type="checkbox" value="1" id="checkcobro" onclick="cambiacobro();" />Incluir Cheques No Cobrados<br>(<b style="font-size: 10px">Se incluiran en el saldo inicial</b>)

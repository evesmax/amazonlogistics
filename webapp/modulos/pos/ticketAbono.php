...
$abono=$cajaController->datosabono($idabono);
...
<div id="receipt_wrapper">
    ...
    <div id="receipt_header" style="text-align:center;">
        ...
        <div id="sale_receipt"><h2>Ticket Abono de Caja</h2></div>
        <div id="sale_time"><!--Fecha y hora--><?php echo $cajaController->formatofecha($abono[0]['fecha']);?></div>
    </div>
    <div id="receipt_general_info" style="text-align:center;">
        <div id="sucursal">Sucursal: <?php echo $abono[0]['sucursal']; ?></div>
        <div id="sale_id">ID Abono: <?php  echo $abono[0]['id']; ?></div>
        <div id="employee"><h3>Cajero: <?php  echo $abono[0]['usuario']; ?></h3></div>
        <div id="employee"><h4>Cliente: <?php  echo $abono[0]['cliente']; ?></h4></div>
    </div>
    ...
    <table id="receipt_items" border='0' align="center">   
        ...
        <tr>
            <td style='text-align:center;'><?php echo $abono[0]['concepto']; ?></td>
            <td style='text-align:right;'>$<?php echo $abono[0]['cantidad']; ?></td>
        </tr>
        <tr>
            <td colspan="1" style='text-align:right;border-top:2px solid #000000;'></td>
            <td colspan="1" style='text-align:right;border-top:2px solid #000000;'><b>Total:</b>$<?php echo number_format($abono[0]['cantidad'],2,".",","); ?></td>
        </tr>
        <tr>
             <td colspan="1" style='text-align:right;border-top:2px solid #000000;'></td>
             <td colspan="1" style='text-align:right;border-top:2px solid #000000;'></td>

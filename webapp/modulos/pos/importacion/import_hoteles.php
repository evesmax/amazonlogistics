...
$data->read(dirname(__FILE__).'/hoteles_temp.xls');
...
unlink(dirname(__FILE__).'/hoteles_temp.xls');
if(intval($sigue))
{
    //Validaciones
...
<script language='javascript'>
    ...
    function sel_chk(id)
    {
        ...
        if(chk)
        {
            $.post('ajax.php?c=hotel&f=reactivarHotelLay', 
                {
                    id  : id,
                    num : 99
                },
        ...
        {
            $.post('ajax.php?c=hotel&f=inactivarHotelLay', 
                {
                    id : id,
                    num : 98
                },
    ...
    {
         $.post('ajax.php?c=hotel&f=confirmarHotelLay', 
         {
            num : num
         },
         function()
         {
            window.location = 'index.php?c=hotel&f=indexGridHoteles'
         });
    }
</script>

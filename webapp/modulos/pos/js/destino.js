...
function guardarHotel() {
    $.ajax({
        url: 'ajax.php?c=destino&f=guardar',
        type: 'POST',
        dataType: 'json',
        data: {
    ...
    .done(function(result) {
        ...
        window.location = window.location.protocol + '//'+document.location.host+window.location.pathname+'?c=destino&f=indexGridDestinos';
    })
    .fail(function() {
        console.log("error");
    })
...
function modalEditarHotel(id, clave, nombre, estatus) {
    $('#inputUpId').val(id);
    $('#inputUpClave').val(clave);
    $('#inputUpNombre').val(nombre);
    $('#inputUpEstatus').val(estatus);
}

function editarHotel() {
    $.ajax({
        url: 'ajax.php?c=destino&f=editar',
        type: 'POST',
        dataType: 'json',
        data: {
            id: $('#inputUpId').val(),
            clave: $('#inputUpClave').val() ,
            nombre: $('#inputUpNombre').val() ,

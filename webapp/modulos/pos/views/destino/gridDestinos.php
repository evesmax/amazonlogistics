				...
				<div class='col-sm-8'>
					<h3>
						...
						<button class="btn btn-primary" data-toggle="modal" data-target=".nuevoHotel">
							<i class="fa fa-plus" aria-hidden="true"></i> Nuevo Destino
						</button>
					</h3>
				</div>
	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="gridSystemModalLabel">Nuevo Destino</h4>
			</div>
...
<div class="modal fade editarHotel" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="gridSystemModalLabel">Editar Destino</h4>
			</div>
			<div class="modal-body">
			<form class="form-horizontal">
			...
			<div class="modal-dialog">
				<div class="modal-content panel-warning">
					...
					<div class="modal-header panel-heading">
						<h4 id="modal-label">Desactivar destino</h4>
					</div>
					<div class="modal-body">
						<p>¿Deseas desactivar este destino?</p>

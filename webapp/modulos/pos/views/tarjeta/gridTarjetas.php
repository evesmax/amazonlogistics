				...
				<div class='col-sm-8'>
					<h3>
						...
						<button class="btn btn-primary" data-toggle="modal" data-target=".nuevoHotel">
							<i class="fa fa-plus" aria-hidden="true"></i> Nueva Tarjeta
						</button>
					</h3>
				</div>
				<div class="col-sm-3">
					<button class="btn btn-primary" > Politica</button>
				</div>
...
-->			
			...
			<div class='row' id='layout_row'>
				<div class='col-sm-12 col-md-offset-2 col-md-5'>
					<b>Subir tarjetas mediante layout</b> / <a href='importacion/tarjetas.xls'>Descargar</a><br />
					<form action='index.php?c=tarjeta&f=subeLayout' method='post' name='archivo' enctype="multipart/form-data" id='arch' onsubmit='return validar(this)'>
			...
			<div class="row">
				<div class="col-sm-12" style="overflow:auto;">
					<table class="table table-hover table-fixed" style="background-color:#F9F9F9; border:1px solid #c8c8c8;" id="tableGrid">
						...
						<tbody>
							<?php 
								foreach ($tarjetasGrid as $key => $value) {
									if($value['estatus']==1){
										$status = '<span class="label label-success">Activo</span>';
										$botones = '<button class="btn btn-primary btn-xs active" title="Editar" data-toggle="modal" data-target=".editarHotel" onclick="modalEditarTarjeta('. "{$value['id']} , '{$value['clave']}'  , '{$value['banco']}'  , '{$value['estatus']}'" .')">
												<span class="glyphicon glyphicon-edit"></span>
											</button>
											<a href="#" class="btn btn-danger btn-xs active" onclick="cambiarEstatus('. "{$value['id']} , '{$value['clave']}'  , '{$value['banco']}'  , '0'" .')" title="Desactivar">
												<span class="glyphicon glyphicon-remove"></span>
											</a>';
									} else {
										$status = '<span class="label label-danger">Inactivo</span>';
										$botones = '<a href="#" class="btn btn-info btn-xs active" onclick="cambiarEstatus('. "{$value['id']} , '{$value['clave']}'  , '{$value['banco']}'  , '1'" .')" title="Activar">
	...
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="gridSystemModalLabel">Nueva Tarjeta</h4>
			</div>
			<div class="modal-body">
				<form class="form-horizontal">
					<div class="form-group">
					    <label for="inputClave" class="col-sm-3 control-label"># Tarjeta</label>
					    <div class="col-sm-9">
					      <input type="text" class="form-control" id="inputClave" >
					    </div>
					  </div>
					  <div class="form-group">
					    <label for="inputNombre" class="col-sm-3 control-label">Banco </label>
					    <div class="col-sm-9">
...
<div class="modal fade editarHotel" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
	<div class="modal-dialog modal-sm" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="gridSystemModalLabel">Editar Tarjeta</h4>
			</div>
			<div class="modal-body">
			<form class="form-horizontal">
				...
				<div class="form-group">
				  ...
				  <div class="form-group">
				    <label for="inputNombre" class="col-sm-3 control-label">Banco </label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="inputUpBanco" >
				    </div>
				  </div>
				  <div class="form-group">
				    <label for="inputEstatus" class="col-sm-3 control-label">Estatus</label>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
				<button type="button" class="btn btn-primary" onclick="editarTarjeta();">Editar</button>
			</div>
			...
			<div class="modal-dialog">
				<div class="modal-content panel-warning">
					...
					<div class="modal-header panel-heading">
						<h4 id="modal-label">Desactivar tarjeta</h4>
					</div>
					<div class="modal-body">
						<p>¿Deseas desactivar esta tarjeta?</p>
		...
		<div id="modalActiva" class="modal fade">
			<div class="modal-dialog">
				<div class="modal-content panel-warning">
					...
					<div class="modal-body">
						<p>Deseas activar esta tarjeta?</p>

...
//  }
    ...
    ?>
        ...
        <tr uuid="<?php echo $value['uuidComplemento']; ?>">
            ...
            <!-- <td></td> -->
<td>
    <a class='btn btn-default' alt='Visualizar PDF' title='Visualizar PDF' onclick='verPdfComPago("<?php echo $value['uuidComplemento']; ?>");'><i class='fa fa-file-pdf-o' aria-hidden='true'></i></a>

    <a class="btn btn-default" alt="Visualizar XML" title="Visualizar XML" onclick='verXmlComPago("<?php echo $value['uuidComplemento']; ?>");'><i class="fa fa-file-code-o" aria-hidden="true"></i></a>

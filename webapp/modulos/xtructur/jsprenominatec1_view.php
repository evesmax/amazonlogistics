...
include('conexiondb.php');
  ...
  function week_bounds( $date, &$start, &$end ) {
   ...
   include('conexiondb.php');
    ...
    $SQL = "SELECT id FROM constru_bit_nominaca where estatus!=2 and per_ini='$sd' AND per_fin='$ed' AND id_tecnico='$id_des' AND id_obra='$id_obra' limit 1;";
    $result = $mysqli->query($SQL);
...
<script>     
    ...
    $.ajax({
      ...
      jQuery("#row_proforma").jqGrid({
        url:'sql_jsprenomina_tec1.php?sd=<?php echo $sd; ?>&ed=<?php echo $ed; ?>&q=3&sema=<?php echo $sema; ?>&id_des=<?php echo $id_des; ?>&sem=<?php echo $semana; ?>&edif=<?php echo $id_edif; ?>',
        datatype: "json",
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <input id="total" type="hidden" value="0.00">
           ...
           <button style="width: 100%" class="btn btn-primary btn-xm pull-right" onclick="generaNominaTe(<?php echo $id_des; ?>,'<?php echo $sd; ?>','<?php echo $ed; ?>');"> Generar Nomina</button>

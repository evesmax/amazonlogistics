...
<script> 
            ...
            $("#jq_arbol").jqGrid({
               ...
               // d.codigo, d.descripcion, d.unidtext, d.pu_destajo, e.vol_tope*d.pu_destajo as total, c.vol_anterior, c.vol_est
                    ...
                    { label: 'Concepto', name: 'concepto',  width: 70, sortable:false },
                     { label: 'Unidad', name: 'unidad',  width: 70, sortable:false },
                    { label: 'Cantidad', name: 'cantidad',  width: 30, sortable:false },
                    { label: 'Val factura', name: 'val_fact',  width: 35, sortable:false,sorttype:"float", formatter:"number" },
                    { label: 'Importe', name: 'importe',  width: 35, sortable:false,sorttype:"float", formatter:"number" },
                    { label: 'Iva', name: 'iva',  width: 35, sortable:false,sorttype:"float", formatter:"number" },
                    { label: 'Total', name: 'total',  width: 35, sortable:false,sorttype:"float", formatter:"number" },
                    { label: 'Factura', name: 'factura',  width: 35, sortable:false },
                    { label: 'Cuenta', name: 'cargo',  width: 35, sortable:false },
            ...
            jQuery("#jq_arbol").jqGrid('navGrid',"#jqp_arbol",
                ...
                buttonicon: "ui-icon-export",
                  onClickButton: function() {
                        $("#jq_arbol").jqGrid('exportarExcelCliente',{nombre:"chica",formato:"excel"});
    ...
    <div class="panel panel-default" >
      ...
      <div class="panel-title">Autorizacion estimacion Caja chica</div>
...
<input type="button" id='enviarb' value="Enviar" style="cursor:pointer" onclick="autorizarestAll('cc',-1,2,1);">
...
<div class="panel panel-default" >
    ...
    <div class="col-sm-2 col-xs-4">
      ...
      <button onclick="pdf_est_chica('chica');" id="btnpdfcomp" class="btn btn-primary btn-xm"><span class="glyphicon glyphicon-download"></span> PDF</button>
    </div>
</div>
...
Todos
  ...
  &nbsp;
    ...
    <button onclick="graficar_ret('est_chica','<?php echo $idses_obra; ?>');" class="btn btn-primary btn-xm"> Visualizar grafica</button>

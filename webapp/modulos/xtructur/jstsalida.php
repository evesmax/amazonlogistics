            ...
            $("#jq_arbol").jqGrid({
               ...
               // d.codigo, d.descripcion, d.unidtext, d.pu_destajo, e.vol_tope*d.pu_destajo as total, c.vol_anterior, c.vol_est
                  ...
                  { label: 'Clave', name: 'clave',  width: 10, sortable:false },
                    ...
                    { label: 'Importe', name: 'Importe',  width: 10, sortable:false,sorttype:"float", summaryTpl: "<b>{0}</b>", formatter:"number",summaryType:'sum' },
...
<input type="button" value="Cancelar traspaso" style="cursor:pointer" onclick="autorizarestAll('tsal',-1,2);">
      ...
      <div class="col-sm-12">
        <div class="navbar navbar-default"  style="margin-top:10px;">
          <div class="navbar-header">
              <div class="navbar-brand" style="color:#333;">Salida de almacenes</div>
          </div>
        </div>
        <div class="row">

      ...
      <div class="col-sm-12">
        <div class="navbar navbar-default"  style="margin-top:10px;">
          <div class="navbar-header">
              <div class="navbar-brand" style="color:#333;">Captura de PU Destajos autorizados</div>
          </div>
        </div>
        <div class="row">
        ...
        <div class="panel-body" >
          <div class="row">
              ...
              <div class="col-sm-2 col-xs-4">
                <input type="button" id="esdes" value="Asignar" style="cursor:pointer;" onclick="savepu(1);" class="btn btn-primary">
              </div>
          </div>
        </div>
        </div>

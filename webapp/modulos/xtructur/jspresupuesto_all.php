    ...
    $(function() {
      $("#file_upload_1").uploadify({
        ...
        'onUploadSuccess' : function(file, data, response) {
          ...
          if(presunom!=''){
            if (confirm("Atencion! Si existe alguna planeacion existente para esta obra, sera eliminada. ¿Desea continuar?") == true) {
              $.ajax({
                  url:"importacion_presupuesto_all.php",
                  type: 'POST',
                  async: false,
      ...
      $("#file_upload_2").uploadify({
        ...
        'onUploadSuccess' : function(file, data, response) {
          ...
          if(presunom!=''){
            $.ajax({
                url:"importacion_presupuesto2_all.php",
                type: 'POST',
                async: false,
                data:{file:file.name,presunom:presunom},
                success: function(r){
      ...
      <div class="col-sm-12">
        <div class="navbar navbar-default"  style="margin-top:10px;">
          <div class="navbar-header">
              <div class="navbar-brand" style="color:#333;">Presupuesto contractual all</div>
          </div>
        </div>
        <div class="row">
        ...
        <div class="panel-body" >
          ...
          <div class="col-sm-3">
            <?php if($ep==1){ echo ''; }else{ echo '<a href="plantilla_planeacion.xlsx">Descargar plantilla</a>'; } ?>
          </div>
          </div>
        </div><!-- ENd panel body -->
        </div>
        ...
        <div class="panel-body" >
          ...
          <div class="col-sm-3">
            <a href="plantilla_planeacion.xlsx">Descargar plantilla</a>
          </div>
        </div>
        </div>
        </div>

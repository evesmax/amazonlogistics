    ...
    <div id="divcuandohayobra" class="row">
      <div class="col-sm-12">
        <div class="panel panel-default" >
						...
						<div class="panel-title">Importar proveedores / subcontratistas</div>
		...
		<div class="col-md-15 col-sm-15">
			<section style="min-height: 650px; background: transparent url('proveedores.png') no-repeat scroll center center / cover ;">
				<br> <br>
				<div class="row">
				...
				<div class="row" style="margin-top: 0.5em !important;">
					...
					<div class="row" style="margin-top: 15em !important;">
						<div class="col-md-12 text-center">
                            ...
                            <br><center><label id='labelf' style="color: #ffffff; font-weight: 500; letter-spacing: 0.03em;"></label><center>
						</div>
					</div>
				...
				<script type="text/javascript">
					...
					$(".btn_3:first").on("click", function(){ $('#miarchi').trigger('click'); });
...
$(function() {
	 ...
	 function programaObra(option){
	 	window.open('plantilla_prov_subc.xlsx');
	 }

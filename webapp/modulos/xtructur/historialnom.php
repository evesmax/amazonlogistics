...
<script> 
            ...
            $("#jq_arbol").jqGrid({
               ...
               // d.codigo, d.descripcion, d.unidtext, d.pu_destajo, e.vol_tope*d.pu_destajo as total, c.vol_anterior, c.vol_est
                   ...
                   { label: 'Monto', name: 'total',  width: 70, sortable:false },
                    ...
                    { label: 'Maestro', name: 'Proveedor',  width: 70, sortable:false },
                   ...
                   { label: 'Hora solicitud', name: 'tsol',  width: 40, sortable:false },
                    ...
                    { label: 'Nomina', name: 'estimacion',  width: 40, sortable:false },
        ...
        grouping: true,
                groupingView: {
                    groupField: ["cat","Proveedor2","estimacion"],
      ...
      <div class="col-sm-12">
        <div class="navbar navbar-default"  style="margin-top:10px;">
          <div class="navbar-header">
              <div class="navbar-brand" style="color:#333;">Historial de movimientos - Nominas</div>
          </div>
        </div>
        <div class="row">

  <script>     
    $(function() {
      ...
      jQuery("#row_proforma").jqGrid({
        url:'sql_jscat_especialidades.php?q=3',
        datatype: "json",
        colNames:['clave','Especialidad'],
        colModel:[
          ...
          {name:'especialidad', index:'especialidad', width:120, sortable:false,editable:true},
        ...
        footerrow: true,
        multiselect:true,
        editurl: "sql_jscat_especialidades.php",
      ...
      <div class="col-sm-12">
        <div class="navbar navbar-default"  style="margin-top:10px;">
          <div class="navbar-header">
              <div class="navbar-brand" style="color:#333;">Catalogo especialidades</div>
          </div>
        </div>
        <div class="row">

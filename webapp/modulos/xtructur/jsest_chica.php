...
<div class="panel panel-default" >
  ...
  <div class="panel-title">Elaboracion Estimacion Caja Chica</div>
  ...
  <div class="col-sm-6">
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <button style="width:100%" id='botoncrear' class="btn btn-primary btn-xm pull-right" onclick="crearestimacion('cc');"> Nueva estimacion</button>
      </div>
    </div>
  </div>

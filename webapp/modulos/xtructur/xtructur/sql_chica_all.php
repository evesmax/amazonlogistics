...
CASE e.estatus 
WHEN 0 THEN concat('Estimacion-',e.id,' Fecha: ',substr(fecha,1,10),' <input type=\"button\" value=\"Cancelar\" style=\"cursor:pointer\" onclick=\"autorizarestAll(\'cc\',',e.id,',',2,');\" > ',' <input type=\"button\" value=\"Autorizar\" style=\"cursor:pointer\" onclick=\"autorizarestAll(\'cc\',',e.id,',',1,');\" >')

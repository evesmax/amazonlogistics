...
WHERE a.id_obra='$idses_obra'  AND wx1.borrado=0  AND a.borrado=0  AND alt.id_tipo_alta=5 AND (alt.estatus='Alta' OR alt.estatus='Incapacitado') group by a.id ORDER BY  Proveedor asc, a.id asc";

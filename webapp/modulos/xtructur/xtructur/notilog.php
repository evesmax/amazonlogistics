...
$SQL = "Select * from constru_notilog order by fecha desc limit 3;";
          ...
          <div class="col-xs-12 tablaResponsiva">
            <table>
              <tr>
                ...
                <td width="200">
                  <div id="jrange" >
                    <input class="form-control" style="width: 90%; margin-bottom: 0em;" />
                    <div></div>
                  </div>
                </td>
                <td width="40">Fin:</td>
              ...
              <td width="200">
                <input type='button' value='Buscar' onclick="buscanoti();">
              </td>
            </tr>
</table>

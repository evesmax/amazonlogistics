...
CASE a.estatus
WHEN 3 THEN concat('Entradas Traspaso-',a.id,' obra ',a.id_obra_entrada,' <button type=\"button\" value=\"Cancelar\" style=\"cursor:pointer\" data-toggle=\"modal\" data-target=\"#myModal\"  data-eid=',a.id, '>Cancelar</button> ',' <input type=\"button\" value=\"Autorizar\" style=\"cursor:pointer\" onclick=\"autorizarestAll(\'tent\',',a.id,',',4,');\" >')
WHEN 2 THEN concat('Entradas Traspaso-',a.id,' obra ',a.id_obra_entrada,' <font color=\"#ff0000\">Entrada Traspaso Cancelada</font>')
WHEN 4 THEN concat('Entradas Traspaso-',a.id,' obra ',a.id_obra_entrada,' <font color=\"#070\">Entrada Traspaso Autorizada</font>')
END as Estimacion
...
where b.id_obra_ent='$id_obra' and a.id_aut_os=3

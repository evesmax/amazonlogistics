...
$i=0;
$SQL2="SELECT c.id_esti, c.imp_sem, a.semana, c.proviene, c.id as idremesa,concat('Rem-',a.id,' Fecha: ',a.fecha) as remesa FROM constru_bit_remesa a 
...
$row = $result->fetch_array();
        ...
        $SQL5 ="SELECT if(a.imp_sem is null,0,a.imp_sem) as imp_semana, a.id as ididremesa from constru_remesas a 
         where a.id_obra='$id_obra' AND a.id_prov='".$row['id_alta']."' AND a.id_esti='".$row['iidd']."' AND a.semana='".$row2['semana']."'  AND a.proviene='".$row2['proviene']."';";

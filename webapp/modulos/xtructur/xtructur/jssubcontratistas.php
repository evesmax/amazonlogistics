    ...
    success: function(r){
      ...
      jQuery("#jq_alta_destajista").jqGrid({
        ...
        {name:'id', width:40,sortable:false,search:true},
          ...
          {name:'tipo_alta',index:'tipo_alta',stype: 'select', width:50, sortable:false,editable:true,edittype:"select",editoptions:{value:'Subcontratista:Subcontratista'},searchoptions:{sopt:['eq'], value:'Subcontratista:Subcontratista' }
          },
          ...
          {name:'imp_cont',index:'imp_cont', width:100, sortable:false,editable:true,sorttype:"float", formatter:"number"},

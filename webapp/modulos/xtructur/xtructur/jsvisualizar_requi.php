    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Cancelar requisicion</h4>
        </div>
        ...
        <input type="hidden" id="idReqModal" value="100">
            <div class="row">
                ...
                <div class="col-sm-9">
                    <textarea id="cancelObs" style="width:100%; height:80px;"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-3">
                    <button class="btn btn-default btn-block" onclick="cancelReq($('#idReqModal').val());">Cancelar</button>
                </div>
                <div class="col-sm-3">
                    <button class="btn btn-default btn-block" data-dismiss="modal">Salir</button>
                </div>
            </div>
        </div>
      </div>
        ...
        $(document).ready(function () {
            $("#jq_arbol").jqGrid({
                ...
                colModel: [
                    ...
                    { label: 'Partida', name: 'partida',  width: 70, sortable:false },
                    { label: 'Especialidad', name: 'especialidad',  width: 70, sortable:false },
                ...
                loadComplete: function() {
                 ...
                 /*   x=0;
                    ...
                    $.each( groups, function( k, v ) {
                        if(v.idx==0){
                            $('.jq_arbolghead_0:eq('+x+') td').append(' <input type="button" value="Cancelar" style="cursor:pointer;" onclick="cancelReq(\''+v.displayValue+'\');" > ');
                            x++;
                        }
                    });
*/

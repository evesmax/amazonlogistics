  ...
  <script>     
    $(document).ready(function () {
      ...
      jQuery("#row_proforma").jqGrid({
        url:'sql_jsestado_rep4.php?mes=<?php echo $mes; ?>&q=3&option='+option,
        datatype: "json",
        colNames:['Anticipos','Estimaciones pagadas', 'Otros ingresos', 'Ingresos','Ingresos - Egresos', 'Estatus'],
        colModel:[
          {name:'Anticipos',index:'Anticipos', width:160, sortable:false,editable:true,sorttype:"float", formatter:"number"},
          {name:'Estimaciones pagadas', index:'Estimaciones_pagadas', width:160, sortable:false,editable:true,sorttype:"float", formatter:"number"},
          {name:'Otros ingresos',index:'Otros_ingresos', width:160, sortable:false,editable:true,sorttype:"float", formatter:"number"},
          {name:'Ingresos', index:'Ingresos', width:160, sortable:false,editable:true,sorttype:"float", formatter:"number"},
          {name:'Ingresos - Egresos',index:'Ingresos-Egresos', width:160, sortable:false,editable:true,sorttype:"float", formatter:"number"},
          {name:'Estatus',index:'Estatus', width:200, sortable:false,editable:true},

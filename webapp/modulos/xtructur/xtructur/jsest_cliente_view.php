  ...
  $.ajax({
    ...
    success: function(r){
      ...
      jQuery("#jq_requisiciones").jqGrid({
        ...
        datatype: "json",
        colNames:['Agrupador','Area','Clave','Descripcion','Unidad','Vol. Tope','PU contrato', 'Importe', 'Vol anterior', 'Vol. Estimacion','Vol acumulado','Vol ejecutar','Imp. Estimacion'],
        colModel:[
            ...
            dataEvents:[{ 
                type: 'change', fn: function(e) {
                  ...
                  $.ajax({
                    ...
                    type: 'POST',
                    dataType: 'JSON',
                    data: {opcion:'desc_cliente_est',id_codigo:id_insumo,ar:'<?php echo $ar; ?>'},
                    success: function(r){

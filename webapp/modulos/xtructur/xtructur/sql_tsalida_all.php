...
CASE a.estatus
WHEN 0 THEN concat('Salidas Traspaso-',a.id,' obra ',a.id_obra_salida,'  <button type=\"button\" value=\"Cancelar\" style=\"cursor:pointer\" data-toggle=\"modal\" data-target=\"#myModal\"  data-eid=',a.id, '>Cancelar</button> ',' <input type=\"button\" value=\"Autorizar\" style=\"cursor:pointer\" onclick=\"autorizarestAll(\'tsal\',',a.id,',',3,');\" >')
WHEN 2 THEN concat('Salidas Traspaso-',a.id,' obra ',a.id_obra_salida,' <font color=\"#ff0000\">Salida Traspaso Cancelada</font>')
WHEN 3 THEN concat('Salidas Traspaso-',a.id,' obra ',a.id_obra_salida,' <font color=\"#070\">Salida Traspaso Autorizada</font>')
END as Estimacion

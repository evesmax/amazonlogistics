<?php
  ...
  function week_bounds( $date, &$start, &$end ) {
    ...
    $SQL = "SELECT a.id, c.cargo, concat('RT-',b.id,' ',d.nombre,' ',d.paterno,' ',d.materno) as aut, a.estatus FROM constru_bit_nominaca a 
...
<script>     
    ...
    $.ajax({
      ...
      jQuery("#row_proforma").jqGrid({
        url:'sql_jsonomina_central.php?id_des=<?php echo $id_des; ?>',
        datatype: "json",
        ...
        footerrow: true,
        multiselect:true,
        editurl: 'sql_jsonomina_central.php?sd=<?php echo $sd; ?>&ed=<?php echo $ed; ?>&q=3&sema=<?php echo $sema; ?>&id_des=<?php echo $id_des; ?>&sem=<?php echo $semana; ?>&edif=<?php echo $id_edif; ?>',
...
<div class="panel panel-default" >
  ...
  <?php if ($row['estatus']==0){ ?>
    ...
    <div class="col-sm-3">
    <button style="width:100%"  class="btn btn-danger btn-xm pull-right" onclick="autorizarest('nomot',2);"> Cancelar</button>

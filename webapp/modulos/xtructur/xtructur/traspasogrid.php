...
$(function() {
  ...
  $.ajax({
    ...
    type: 'POST',
    dataType: 'JSON',
    data: {opcion:'traeme_obras',obra_sal:'<?php echo $obra_sal; ?>'},
    success: function(r){
      sestmp=$('#sestmp').val();
      ...
      <div class="col-sm-12">
        ...
        <div class="row">
          ...
          <div class="row" style="padding:0px;">
              <div class="col-sm-6">
                <label>Quien recibe obra salida:</label>
          ...
          <div class="row" style="padding:15px 0 0 0;">
              <div class="col-sm-6">
                <button id="btnGenReq" class="btn btn-primary btn-sx" onclick="guardaTraspaso(<?php echo $sestmp; ?>,<?php echo $obra_sal; ?>,<?php echo $obra_ent; ?>);" id="btnGenReq"> Guardar traspaso</button>
              </div>
          </div>

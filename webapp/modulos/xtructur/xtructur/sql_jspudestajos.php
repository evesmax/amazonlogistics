...
if(isset($oper) && $oper=='edit'){
	...
	$unidad = $_POST['unidad'];
	$corto = $_POST['corto'];
	$pu_destajo = $_POST['pu_destajo'];

	$mysqli->query("UPDATE constru_recurso SET pu_destajo='$pu_destajo' WHERE id='$id';");
	exit();
}

    ...
    <div id="divcuandohayobra" class="row">
      <div class="col-sm-12">
        <div class="panel panel-default" >
						...
						<div class="panel-title">Importar proveedores</div>
						</div><!-- End panel heading -->

						<!-- Panel body -->
						<div class="panel-body" >
						<div class="col-md-12" style="padding:0px;">
			 	<b>Descarga plantilla de importacion de proveedores</b>
			 	<div class="row">
				 <div class="col-md-2">
...
$("#file_upload_2").uploadify({
	...
	'onUploadSuccess' : function(file, data, response) {
	 ...
	 function programaObra(option){
	 	window.open('plantilla_prov.xlsx');
	 }

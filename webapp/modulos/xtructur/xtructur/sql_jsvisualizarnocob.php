...
WHERE a.id_bit_solicitud=0 AND a.naturaleza='No cobrable' And a.id_obra='$id_obra' AND a.borrado=0 and a.sestemp='$sestmp' ORDER BY a.$sidx $sord LIMIT $start,$limit";
$result = $mysqli->query($SQL);

  ...
  $.ajax({
    ...
    success: function(r){
      ...
      jQuery("#jq_alta_destajista").jqGrid({
        ...
        datatype: "json",
        colNames:['ID','Estatus','Fecha de captura','Fecha de ingreso','Dias de credito','Limite de credito','Tipo','Razon social','RFC','Domicilio','Colonia','CP','Municipio','Estado','Telefono empresa','Apellido paterno','Apellido materno','Nombres','Telefono personal','Correo'],
        colModel:[
        {name:'id', width:40,sortable:false,search:true},
          ...
          {name:'tipo_alta',index:'tipo_alta',stype: 'select', width:50, sortable:false,editable:true,edittype:"select",editoptions:{value:'Proveedor:Proveedor'},searchoptions:{sopt:['eq'], value:'Proveedor:Proveedor' }
          },
      ...
      <div class="col-sm-12">
        <div class="navbar navbar-default"  style="margin-top:10px;">
          <div class="navbar-header">
              <div class="navbar-brand" style="color:#333;">Alta de proveedores</div>
          </div>
        </div>
        <div class="row">

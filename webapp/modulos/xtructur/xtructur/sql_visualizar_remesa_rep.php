...
$i=0;
$SQL2="SELECT c.id_esti, c.imp_sem, c.proviene FROM constru_bit_remesa a 
...
where a.id='$sema' and a.id_obra='$id_obra';";
...
$tersum=0;
    ...
    $responce->rows[$i]['cell']=array($row['Proveedor'],substr($row['fecha'],0,10),$row['estimacion'],$row['factura'],$row['total'],$sumap,$sp,$row2['imp_sem'],'OOO');
    $i++;
}  

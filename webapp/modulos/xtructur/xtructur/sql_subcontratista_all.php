...
if($filtro_semana!=0){
    ...
    $cadenafiltro.=" AND yearweek(fecha)='".$filtro_semana."' ";
}
...
CASE a.estatus 
WHEN 0 THEN concat('Estimacion-',a.id,' Fecha: ',substr(fecha,1,10),' ','<input type=\"button\" value=\"Cancelar\" style=\"cursor:pointer\" onclick=\"autorizarestAll(\'sub\',',a.id,',',2,');\" > ',' <input type=\"button\" value=\"Autorizar\" style=\"cursor:pointer\" onclick=\"autorizarestAll(\'sub\',',a.id,',',1,');\" >')

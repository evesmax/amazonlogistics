...
$SQL = "SELECT
concat(bx.cliente) as Cliente,
CASE b.estatus 
WHEN 0 THEN concat('Estimacion-',b.id,' Fecha: ',substr(fecha,1,10),' ','<input type=\"button\" value=\"Cancelar\" style=\"cursor:pointer\" onclick=\"autorizarestAll(\'cli\',',b.id,',',2,');\" > ',' <input type=\"button\" value=\"Autorizar\" style=\"cursor:pointer\" onclick=\"autorizarestAll(\'cli\',',b.id,',',1,');\" >')
WHEN 2 THEN concat('Estimacion-',b.id,' Fecha: ',substr(fecha,1,10),' ','<font color=\"#ff0000\">Estimacion Cancelada</font>')
WHEN 1 THEN concat('Estimacion-',b.id,' Fecha: ',substr(fecha,1,10),' ','<font color=\"#070\">Estimacion Autorizada</font>')
END as Estimacion, a.id_insumo,
c.precio_costo, c.codigo, c.descripcion, c.unidtext, a.vol_anterior, a.vol_estimacion

...
CASE a.estatus 
WHEN 0 THEN concat('Adicional-',a.id,' <input type=\"button\" value=\"Cancelar\" style=\"cursor:pointer\" onclick=\"autorizarestAll(\'sol\',',a.id,',',2,');\" > ',' <input type=\"button\" value=\"Autorizar\" style=\"cursor:pointer\" onclick=\"autorizarestAll(\'sol\',',a.id,',',1,');\" >')

...
if($_search=='true'){
 ...
 $SQL = "SELECT e.sal_semanal, c.per_ini, c.per_fin, 'Varias' as anom, a.id as idemp, concat('DEST-',a.id,' ',b.nombre,' ',b.paterno,' ',b.materno) as empleado, c.*, (c.lun+c.mar+c.mie+c.jue+c.vie+c.sab) as diast, (e.sal_semanal/6)*(c.lun+c.mar+c.mie+c.jue+c.vie+c.sab) as importedt, ((e.sal_semanal/6)*(c.lun+c.mar+c.mie+c.jue+c.vie+c.sab))+c.impdf-c.descinf as sub1, ((e.sal_semanal/6)*(c.lun+c.mar+c.mie+c.jue+c.vie+c.sab))+c.impdf-c.descinf+c.difd as totalp, c.imphe 

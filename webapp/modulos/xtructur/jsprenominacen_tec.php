...
<div class="panel panel-default" >
      ...
      <div class="panel-title">Elaboracion Nomina Tec-Admon Oficina Central</div>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <select class="form-control" id="desta">
          <option selected="selected" value="1">Tecnicos oficina central</option>
        </select>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="row">
          <div class="col-md-6 col-md-offset-6" style="padding-top: 20px;">
           ...
           <button id="btnGenReq"  class="btn btn-primary btn-xm pull-right" onclick="verprenominatecce();"> Ver nomina</button>

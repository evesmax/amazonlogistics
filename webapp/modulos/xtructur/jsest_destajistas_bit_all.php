            ...
            jQuery("#jq_arbol").jqGrid('navGrid',"#jqp_arbol",
                ...
                buttonicon: "ui-icon-export",
                  onClickButton: function() {
                        $("#jq_arbol").jqGrid('exportarExcelCliente',{nombre:"dest",formato:"excel"});
...
<input type="button" id='enviarb' value="Enviar" style="cursor:pointer" onclick="autorizarestAll('des',-1,2,1);">
...
Todos
  ...
  &nbsp;
    ...
    <button onclick="graficar_ret('est_des','<?php echo $idses_obra; ?>');" class="btn btn-primary btn-xm"> Visualizar grafica</button>

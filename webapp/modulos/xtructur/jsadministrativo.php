    ...
    success: function(r){
      ...
      jQuery("#jq_alta_tecnico").jqGrid({
        ...
        colModel:[
                    ...
                    {name:'tipo_alta',index:'tipo_alta',stype: 'select', width:50, sortable:false,editable:true,edittype:"select",editoptions:{value:'Administrativo:Administrativo'},searchoptions:{sopt:['eq'], value:'Tecnico:Tecnico' }
                    },
       ...
       /* groupingView : {
        ...
        editurl: "sql_jsadministrativos.php",
      ...
      jQuery("#jq_alta_tecnico").jqGrid('navGrid',"#jqp_alta_tecnico",
        ...
        {beforeShowForm: function(form){ 
            ...
            $('<tr class="FormData" id="tr_AddInfo"><td class="CaptionTD ui-widget-content"><b>Nomina:</b></td></tr>').insertAfter(planeacion);
      ...
      <div class="col-sm-12">
        <div class="navbar navbar-default"  style="margin-top:10px;">
          <div class="navbar-header">
              <div class="navbar-brand" style="color:#333;">Alta de Administrativos</div>
          </div>
        </div>
        <div class="row">

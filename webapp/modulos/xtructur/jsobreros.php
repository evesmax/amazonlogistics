    ...
    success: function(r){
      ...
      jQuery("#jq_alta_tecnico").jqGrid({
        ...
        colModel:[
          ...
          {name:'id_responsable',index:'id_responsable',stype: 'select', width:50, sortable:false,editable:true,edittype:"select",editoptions:{value:'0:Seleccione;'+r.resp},searchoptions:{sopt:['eq'], value:'0:Seleccione;'+r.resp },
            editrules: {edithidden:true},
            hidden:true
          },


          {name:'tipo_alta',index:'tipo_alta',stype: 'select', width:50, sortable:false,editable:true,edittype:"select",editoptions:{value:'Obrero:Obrero'},searchoptions:{sopt:['eq'], value:'Obrero:Obrero' }
          },
      ...
      <div class="col-sm-12">
        <div class="navbar navbar-default"  style="margin-top:10px;">
          <div class="navbar-header">
              <div class="navbar-brand" style="color:#333;">Alta de obreros</div>
          </div>
        </div>
        <div class="row">

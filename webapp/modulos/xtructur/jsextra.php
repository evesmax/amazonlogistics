  ...
  $.ajax({
    ...
    success: function(r){
      ...
      jQuery("#jq_requisiciones").jqGrid({
        url:'sql_jsvisualizarextra.php?q=3&sestmp='+sestmp,
        datatype: "json",
        ...
        editurl: "sql_jsvisualizarextra.php?sestmp="+sestmp,
      ...
      <div class="col-sm-12">
        <div class="navbar navbar-default"  style="margin-top:10px;">
          <div class="navbar-header">
              <div class="navbar-brand" style="color:#333;">Solicitud de Extraordinarios</div>
          </div>
        </div>
        <div class="row">
...
<div class="row">&nbsp;</div>
      ...
      <input class="form-control" id="total" type="text" value="0" disabled="disabled">
          ...
          <div class="col-sm-4" style="padding-top: 15px;">
            ...
            <button style="width:100%" class="btn btn-primary btn-xm pull-right" id="btnGenReq" onclick="generaext(<?php echo $sestmp; ?>);"> Generar Solicitud</button>

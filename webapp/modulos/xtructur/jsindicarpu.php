<script>    
    $(function() {
      ...
      jQuery("#jq_asignacion").jqGrid({
        ...
        url:'sql_jsindicarpu.php?q=3',
        datatype: "json",
        colNames:['Codigo','Naturaleza','Clave','Descripcion', 'U.M.', 'Cantidad', 'Precio unitario', 'Importe','Destajo','Subcontrato'],
        colModel:[
        ...
        //  {name:'corto',index:'corto', width:130, sortable:false,editable:true},
          ...
          {name:'esdestajo',index:'esdestajo', width:100, sortable:false,editable:true,edittype: 'checkbox', editoptions: { value: "True:False" },formatter: "checkbox", formatoptions: { disabled: true} },
          {name:'essubcontrato',index:'essubcontrato', width:100, sortable:false,editable:true,edittype: 'checkbox', editoptions: { value: "True:False" },formatter: "checkbox", formatoptions: { disabled: true} }
      ...
      <div class="col-sm-12">
        <div class="navbar navbar-default"  style="margin-top:10px;">
          <div class="navbar-header">
              <div class="navbar-brand" style="color:#333;">Concepto a Destajo o Subcontrato</div>
          </div>
        </div>
        <div class="row">
        ...
        <div class="panel-title">Asignar tipo de PU</div>
        ...
        <div class="panel-body" >
          <div class="row">
            <div class="col-sm-12">
              ...
              <button id="esdes" class="btn btn-primary" onclick="asignpu(1)"> Es destajo</button>

              <button id="essub" class="btn btn-primary" onclick="asignpu(2)"> Es subcontrato</button>
              
              <button id="esambos" class="btn btn-primary" onclick="asignpu(3)"> Es ambos</button>
              
              <button id="esninguno" class="btn btn-primary" onclick="asignpu(4)"> Ninguno</button>

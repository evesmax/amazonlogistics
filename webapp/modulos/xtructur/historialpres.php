...
<script> 
   ...
   { label: 'Naturaleza', name: 'naturaleza',  width: 40, sortable:false },
      ...
      <div class="col-sm-12">
        <div class="navbar navbar-default"  style="margin-top:10px;">
          <div class="navbar-header">
              <div class="navbar-brand" style="color:#333;">Historial de movimientos - Presupuestos</div>
          </div>
        </div>
        <div class="row">

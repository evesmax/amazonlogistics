...
header('Content-Disposition: attachment; filename=expSubc_'.$fecha.".xls");
...
$filaTH='';
    ...
    <th>Correo</th>
    <th>Importe de Contrato</th>
    <th>Adendum 1</th>
    <th>Adendum 2</th>
    <th>Adendum 3</th>
    <th>% de anticipo</th>
    <th>% de fondo de garantía</th>';
...
WHERE 1=1 AND a.id_obra='$id_obra' AND a.id_tipo_alta=4 AND a.borrado=0;";
    ...
    while($row = mysql_fetch_assoc($result)) {
        ...
        $cuerpo.='<td>'.$row['imp_cont'].'</td>';
        $cuerpo.='<td>'.$row['ade1'].'</td>';
        $cuerpo.='<td>'.$row['ade2'].'</td>';
        $cuerpo.='<td>'.$row['ade3'].'</td>';
        $cuerpo.='<td>'.$row['anticipo'].'</td>';
        $cuerpo.='<td>'.$row['por_fondo_garantia'].'</td>';
        $cuerpo.='</tr>';

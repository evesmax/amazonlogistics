...
$SQL = "SELECT if(sum(a.imp_estimacion) is null,0, sum(a.imp_estimacion)) total
...
WHERE a.id_obra='$id_obra' AND estatus='1';";
  ...
  if($result->num_rows>0) {
    ...
    right join constru_bit_cobros b on b.id=id_bit_cobros
     where a.id_obra='$id_obra' AND b.estatus=1 AND a.id_esti is not null;";
...
<div class="row">
  <div class="col-sm-6">
    <div class="row">
      <div class="col-sm-4">
        <label>Total de Cobros:</label>
        <input class="form-control" id="ttp" value="<?php echo $sp; ?>" disabled="disabled">
      </div>
      <div class="col-sm-4">
        <label>Monto:</label>
...
$('#fecente').datepicker({ dateFormat: "yy-mm-dd" }); 
            ...
            $("#jq_arbol").jqGrid({
                url:'sql_visualizar_cobro.php?sema=<?php echo $sema; ?>',
                datatype: "json",
                colModel: [
                   ...
                   // { label: 'Importe', name: 'importe',  width: 60, sortable:false },
                    ...
                    { label: 'Importe Sem: <?php echo $sema; ?>', name: 'impsem__',  width: 100, sortable:false},
                     { label: 'Metodo de Pago', name: 'FormaPago',  width: 60, sortable:false}
                    /*
            ...
            jQuery("#jq_arbol").jqGrid('navGrid',"#jqp_arbol",
                ...
                buttonicon: "ui-icon-export",
                  onClickButton: function() {
                        $("#jq_arbol").jqGrid('exportarExcelCliente',{nombre:"cobros",formato:"excel"});
      ...
      <div class="col-sm-12">
        <div class="navbar navbar-default"  style="margin-top:10px;">
          <div class="navbar-header">
              <div class="navbar-brand" style="color:#333;">Entrada</div>
          </div>
        </div>
        <div class="row">
    ...
    <div class="panel panel-default" >
      ...
      <!--<div class="col-sm-4" style='display:none;'>
        ...
        <div class="col-sm-4" style="padding-top: 25px;">
           <button class="btn btn-primary btn-xm" onclick="generaCob(<?php echo $sestmp; ?>,0,0);"> Realizar cobro</button>

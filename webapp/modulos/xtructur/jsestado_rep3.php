  ...
  <script>     
    $(document).ready(function () {
      ...
      jQuery("#row_proforma").jqGrid({
        url:'sql_jsestado_rep3.php?mes=<?php echo $mes; ?>&q=3&option='+option,
        datatype: "json",
        colNames:['Pasivos vencidos','Pasivos por vencer', 'Total pasivos', 'Remesas acumuladas','Egresos'],
        colModel:[
          {name:'Pasivos vencidos',index:'Pasivos_vencidos', width:160, sortable:false,editable:true,sorttype:"float", formatter:"number"},
          {name:'Pasivos por vencer', index:'Pasivos_por_vencer', width:160, sortable:false,editable:true,sorttype:"float", formatter:"number"},
          {name:'Total pasivos',index:'Total_pasivos', width:160, sortable:false,editable:true,sorttype:"float", formatter:"number"},
          {name:'Remesas acumuladas', index:'Remesas_acumuladas', width:160, sortable:false,editable:true,sorttype:"float", formatter:"number"},
          {name:'Egresos',index:'Egresos', width:160, sortable:false,editable:true,sorttype:"float", formatter:"number"}
        ...
        */
        ...
        footerrow: true,
        multiselect:true,
        editurl: "sql_jsestado_rep3.php?mes=<?php echo $mes; ?>",

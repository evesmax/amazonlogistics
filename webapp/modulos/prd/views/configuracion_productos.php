...
<body>
	<div class="container well" style="margin-top: 20px;"> 
		...
		<ul class="nav nav-tabs">
			...
			<li><a href="#3" data-toggle="tab"> Bascula</a></li>
			<li><a href="#4" data-toggle="tab"> Clasificacion</a></li>
		</ul>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="tab-content">
					<div class="tab-pane active" id="1"> <!-- Div 1 -->
						<div class="col-sm-12">
							<div class="row">
								...
								<div class="col-md-3">
									<input type="checkbox" name="marcaTodoPeso" id="marcaTodoPeso"/>
									<label for="marcaTodoPeso">Seleccionar todo</label>	
								</div>
								<div class="col-md-3">
									<input type="checkbox" name="marcaTodocaja" id="marcaTodocaja"/>
									<label for="marcaTodocaja">Seleccionar todo</label>	
								</div>
							...
							<div class="checkbox">
								<div class="row div1">
									...
									<div class="col-md-3 todos3">
										<label>
											<input type="checkbox" class="vendible" name="vendible"
											<?php if( $valor['vendible']==1){ echo 'checked';}else{ echo '';}?>> Vendible
										</label>
									</div>
										<div class="col-md-3 todos4">
										<label>
											<input type="checkbox" class="validaxpeso" name="validaxpeso "
											<?php if( $valor['validaxpeso']==1){ echo 'checked';}else{ echo '';}?>>Pesable
										</label>
									</div>
									<div class="col-md-3 todos5">
										<label>
											<input type="checkbox" class="cajamaster" name="cajamaster "
											<?php if( $valor['caja_master']==1){ echo 'checked';}else{ echo '';}?>>Caja master
										</label>
									</div>
								</div>
							</div>
					...
					<div class="tab-pane" id="3"> <!-- Div2 -->
						<div class="col-sm-12">
							<div class="row">
								<div class="col-md-12">Uso de bascula a nivel instancia</div>
								<div class="col-md-3">
									<input type="checkbox" name="validarpeso" id="validarpeso"
									<?php if( $Array['conf']['usar_bascula']==1){echo 'checked'; ;}else{echo ''; }?>>
									
									<script>
										<?php if( $Array['conf']['usar_bascula']==1){?>
									...
									<input type="hidden"  id="peso" name="peso" value="<?php echo $Array['conf']['usar_bascula'];?>" />
									<label for="validarpeso">Pesado</label>	
								</div>
							</div>
						</div>
					</div>
					<div class="tab-pane" id="4"> <!-- Div4 -->
						<div class="col-md-12">Clasificacion de insumos y material transformado</div>
						<div class="col-md-3">
									<input type="checkbox" name="clasifi" id="clasifi"
									<?php if( $Array['clasifica']['clasificador_producto']==1){echo 'checked'; }?>>
									<input type="hidden"  id="cla" name="cla" value="<?php echo $Array['clasifica']['clasificador_producto'];?>" />

			...
			<div class="col-sm-12">
				<div class="form-group">
					...
					<div id="insumos_block18" class="col-sm-12 p0" style="">
                        ...
                        <div class="col-sm-3" style="margin-top: 10px;">
                            <input existen11="<?php echo $v['existen']; ?>" id="b11_<?php echo $_REQUEST['idop'] . '_' . $v['idProducto']; ?>"  readonly type="text" name="" value="<?php echo($v['canti'] * $v['totaldeproduct'] + $arrayreabasto[$v['idProducto']]); ?>" class="form-control b11">
                        </div>
                        <div class="col-sm-3" style="margin-top: 10px;">

	...
	<!--
		...
		<!-- <div class="row">
			<div class="col-md-12 col-sm-12">
				<b>Seleccione un tipo de produccion</b>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<select id="sel_ciclo" class="form-control" onchange="recetas.selCiclo();">
					<option value="0" selected="selected">Nueva Proceso</option>
					<option value="1">Ciclo ligero (con mermas)</option>
					<option value="2">Ciclo ligero (sin mermas)</option>
				</select>
			</div>
		</div> -->
				...
				<div class="panel-group" id="accordion_acciones" role="tablist" aria-multiselectable="true">
					...
					<div class="panel panel-default">
						...
						<div hrefer class="panel-heading" id="heading_pasos" role="tab" role="button" style="cursor: pointer" data-toggle="collapse" data-parent="#accordion_pasos" href="#tab_pasos" aria-controls="collapse_pasos" aria-expanded="true">
							...
							<br>
							<input type="text" id="PasoEditar" value="" hidden> 
						</div>
						
						<div id="tab_acciones" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_insumos">
							<div class="panel-body">
								<select onchange="recetas.cambiap($(this).val());" id="sel_productos" class="selectpicker" data-width="100%" <?php if( isset($objeto['modi']) ){ echo 'disabled'; }else{  } ?> >
									<option selected="selected" value="0">Seleccione un producto</option>
									<?php
		...
		<div class="row">
			...
			<div id="pacciones" class="col-md-12 col-sm-12" style="display: none;">
									...
									<tbody><?php
										...
										foreach ($datos['acciones_procesos_produccion'] as $k => $v) { ?>
											<tr id="tr_<?php echo $v['id'] ?>">
												<td align="center" class="idacciones">
													<?php echo $v['id'] ?>
												</td>
												<td>
													<?php echo $v['nombre'] ?>
...
<div class="col-md-7">
	<div class="panel panel-<?php echo $panel ?>">
		...
		<div class="panel-body">
				...
				<div class="col-md-6">
					<h3><small>Producto:</small></h3>
							<div class="input-group input-group-lg" id="notificaciones">
								...
								<select id="sel_productos" class="selectpicker" data-width="80%" <?php if( isset($objeto['modi']) ){ echo 'disabled'; }else{  } ?> ><?php
									foreach ($datos['insumos_preparados_formula'] as $key => $value) {
										$select = ($datos['productos_formula'] == $value['id']) ? 'selected' : '' ; ?>
			...
			<div class="row">
				<div class="col-md-8 col-sm-8">
				<?php if( isset($objeto['modi']) ){ $mod=1;  }else{ $mod=0; } ?>
					<button
						...
						class="btn btn-success btn-lg"
						data-loading-text="<i class='fa fa-refresh fa-spin'></i>"
						onclick="recetas.guardar_procesos_produccion2(<?php echo $mod; ?>)">

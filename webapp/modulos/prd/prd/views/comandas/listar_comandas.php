...
// Valida que existan comandas en los parametros seleccionadas
	...
	<div class="row">
		...
		<div id="grafica_comandas_lineal" class="col-xs-8" style="height: 40%">
	...
	<table id="tabla_comandas" class="table table-striped table-bordered" cellspacing="0" width="100%">
		<thead>
			<tr>
				...
				<!-- <th align="center"><strong><i class="fa fa-user"></i></strong></th> <!-- Num personas -->
				<!-- <th align="center"><strong><i class="fa fa-cubes"></i></strong></th> <!-- Tipo -->

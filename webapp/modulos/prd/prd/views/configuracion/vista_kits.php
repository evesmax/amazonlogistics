			...
			<div class="col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12" style="margin-top: 10px">
								<button 
									id="btn_nueva" 
									onclick="configuracion.vista_nuevo_kit({div:'div_kits', btn:'btn_nueva', panel:'success'})" 
								...
								<button 
									id="btn_editar" 
									onclick="configuracion.vista_editar_kit({
												div: 'div_editar',
												vista: 'editar_kit',
												btn: 'btn_editar',
												panel: 'primary', 
								...
								<button 
									id="btn_eliminar"
									onclick="configuracion.vista_eliminar_kit({
												div:'div_eliminar', 
												btn:'btn_eliminar', 
												panel:'danger', 
												vista:'eliminar_kit', 
				    ...
				    <div class="panel-body">
						<div id="div_kits" class="row" style="overflow: scroll;height:75%">
							<!-- En esta div se carga el contenido de las kits -->
						</div>
				  	</div>
				</div>
			</div>
					...
					<div class="modal-body">
						<div class="row" style="overflow: scroll;height:60%">
							<div class="col-xs-12" id="div_editar">
								<!-- En esta div se cargan las kits e insumos preparados -->
							</div>
						</div>
					</div>
				</div>
					...
					<div class="modal-body">
						<div class="row" style="overflow: scroll;height:60%">
							<div class="col-xs-12" id="div_eliminar">
								<!-- En esta div se cargan las kits -->
							</div>
						</div>
					</div>
				</div>
...
<script>
// Carga la vista para editar las kits
	// $('#btn_nueva').click();
	$('#btn_editar').click();
</script>
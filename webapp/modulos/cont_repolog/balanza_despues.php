	...
	$(document).ready(function(){
		...
		switch(txt_exec)
		{
			case "1":// Nivel TODOS - balanza
				...
				break;
			case "2":// Cuentas de Mayor - balanza_2
				$("#exec, #tabla_reporte, #balanza").remove();
				break;
			case "3":// Cuentas AFECTABLES - balanza
				$('#exec, #tabla_reporte, #balanza_2, #balanza tbody tr.mayor').remove();
				break;
		}
	});

...
function generaexcel()
			{
				$().redirect('../../modulos/cont/views/fiscal/generaexcel.php', {'cont': $("#idcontenido_reporte table:contains('Polizas Impresas')").html(), 'name': 'Polizas Impresas de ' + $('#empresa tr td').html()});
			}
</script>

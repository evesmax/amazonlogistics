   ...
   //VARIABLES DEL ENVIO
		...
		$sqlestatus="Select lt.referencia1 otfc, lt.fecha,  
                                ...
                                of.idfabricante, obo.idbodega, obd.idbodega idbodegadestino, ot.idtransportista, lt.idproducto,
                                    ...
                                    format(le.cantidad1,2) cantidad1, format(le.cantidad2,2) cantidad2, le.consecutivobodega, le.folios,
									le.observaciones,le.licenciaoperador,le.idempleado,obo.responsable
		...
		$conexion->cerrar_consulta($result);                        
            ...
            //Precio Bulto
            $fecha2 = new DateTime($fechaenvio);
            $fechaprecio = $fecha2->format('Y-m-d'); 
            $preciobulto=0;
            ...
            $importetotal=$preciobulto*$cantidad1;
					...
					$html.="<table class='reporte' width='100%'>";
						...
						$html.="<tr align=left>
                                                            <td colspan=2>
																...
																*Valor declarado para efectos del Art. 76, del Reglamento de Autotransportes y Servicios Auxiliares de la Ley de Caminos, Puentes y Autotransporte Federal y/o El Art. No. 52 de la Ley Reglamentaria del Servicio Ferroviario y forma parte de la Carta Porte presentada por el Transportista. .
                                                            </td>
                                                        </tr>";                                                

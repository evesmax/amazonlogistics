     ...
     class registroincidencias extends Catalogos
     {
      ...
      function vistaIncidencias(){
         ...
         $nominaActual       = $this->CatalogosModel->nominasActivas();
...
echo $eliminaInci= $this ->incidenciasModel->eliminarincidencia($_REQUEST['idempleado'],$_REQUEST['idnomp'],$_REQUEST['fecha']);
...
function almacenaDiaFest(){
  $almacenaDiaFest=$this->incidenciasModel->almacenaDiaFest($_REQUEST['txtfecha'],$_REQUEST['idnomp']);
}

...
<!-- **	//////////////////////////- -				JS 						--///////////////////// **-->
	...
	<!-- printarea -->
		<script src="../../libraries/PrintArea/js/jquery.printarea.js"></script>
	<!-- DataTables  -->
			...
			<div class="col-xs-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12" style="margin-top: 10px">
								<button 
									id="btn_nuevo" 
									onclick="configuracion.vista_nuevo_menu({div:'div_menu', btn:'btn_nuevo', panel:'success'})" 
								...
								<button 
									id="btn_editar" 
									onclick="configuracion.vista_editar_menu({div:'div_editar', btn:'btn_editar', panel:'primary'})" 
									data-toggle="modal" 
								...
								<button 
									id="btn_eliminar"
									onclick="configuracion.vista_eliminar_menu({div:'div_eliminar', btn:'btn_eliminar', panel:'success'})" 
									data-toggle="modal" 
				    ...
				    <div class="panel-body">
						<div id="div_menu" class="row" style="overflow: scroll;height:75%">
							<!-- En esta div se carga el contenido de los menu -->
						</div>
				  	</div>
				</div>
			</div>
					...
					<div class="modal-body">
						<div class="row" style="overflow: scroll;height:60%">
							<div class="col-xs-12" id="div_editar">
								<!-- En esta div se cargan los menus -->
							</div>
						</div>
					</div>
				</div>
...
<script>
// Carga la vista para editar los menu
	// $('#btn_nuevo').click();
	$('#btn_editar').click();
</script>
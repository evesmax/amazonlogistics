...
<div class="row">
	<div class="col-xs-12">
		<table id="tabla_combos_editar" class="table table-striped table-bordered" cellspacing="0" width="100%">
			<thead>
				<tr>
				...
				// Genera una cadena con los nombres de lo productos
					...
					<tr>
						...
						<td align="center"><?php
							...
							<button 
								id="btn_editar_<?php echo $v['id_combo'] ?>" 
								data-loading-text="<i class='fa fa-refresh fa-spin'></i>" 
								class="btn btn-primary btn-lg" 
								title="Editar" 
								onclick="configuracion.editar_combo(<?php echo $producto  ?>)">
	...
	<script>
		configuracion.convertir_dataTable({id: 'tabla_combos_editar'});
	</script>
</div> 
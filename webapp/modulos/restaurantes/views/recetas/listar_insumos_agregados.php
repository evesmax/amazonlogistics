...
if (!empty($_SESSION['insumos_agregados']['insumos'])) { ?>
	<table id="tabla_insumos_agregados" class="table table-striped table-bordered" cellspacing="0" width="100%">
		<thead>
			<tr>
				<th align="center" class="default"><strong>Cantidad</strong></th>
				<th align="center" class="default"><strong>Modificador</strong></th>
				<th align="center" class="default"><strong>Insumo</strong></th>
				<th class="default"><strong>Unidad</strong></th>
				<th align="center" class="default"><strong>Costo Proveedor</strong></th>
				<th align="center" class="default"><strong>Costear</strong></th>
				<th align="center" class="default"><strong>Costo Preparacion</strong></th>
			</tr>
		</thead>
		<tbody><?php
	...
	<table id="tabla_insumos_agregados" class="table table-striped table-bordered" cellspacing="0" width="100%">
		...
		<tbody><?php			
			...
			// Opciones del select
				...
				<tr <?php if($v['tipo_producto'] == 2){ echo 'class="warning"'; } ?>>

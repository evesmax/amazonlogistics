                ...
                <div class="container"  style="overflow:auto">
                    <div class="panel-heading ">
                        <div aling="center">
                            ...
                            <select id="repartidor" class="form-control" style="width: 70%;" multiple="multiple">
                                <option value="0" selected>-Todos-</option>                        
                            </select>
                            <button class="btn btn-default" onclick="reloadRep();" >Procesar</button>
                             <button id="pause" class="btn btn-default" onclick="pause();"><span class='glyphicon glyphicon-pause'></span></button> 
                             <button id="play" class="btn btn-default" onclick="play();"><span class='glyphicon glyphicon-play'></span></button>
                        </div>
                        <br>
                    </div>
                    <div class="col-sm-12">
                        <span id="total_rep" style="font-weight: bold; float:right">Total: $0.00</span>
                        ...
                        <thead>
                          <tr>
                            ...
                            <th td width="30">Precio comanda</th>

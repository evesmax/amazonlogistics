...
<!-- **	//////////////////////////- -				FIN JS 				--///////////////////// **-->
	...
	<!-- Modal Mesas -->
		<div class="modal fade" style="height:95%" id="modal_mesas_ch" tabindex="-1" role="dialog" aria-labelledby="titulo_mesas" data-backdrop="static">
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<button id="btn_cerrar_mesas_ch" type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
						<h4 class="modal-title" id="titulo_mesas">Seleccionar</h4>
					</div>
					<div class="modal-body">
						<div class="row" style="overflow: scroll;height:55%">
							<div class="col-xs-12" id="contenedor_ch">

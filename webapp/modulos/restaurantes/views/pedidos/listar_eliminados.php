...
<div class="row" style="height: 100%;">
	...
	<div class="col-md-10 col-xs-10 div_scroll_x" id="div_elim" style="height: 100%;">
		<?php foreach ($eliminados as $key => $value) {
			if(!empty($value['persona']) &&!empty($value['persona'][1]['productos'])){ $exist = 1; ?>
			<div
				class="btn btn-coman" id="elim-<?php echo $key?>" style="height: 65vh; cursor: auto; margin: 5px">
				<div class="row" style="width:250px;">       
				   ...
				   <div class="row" style="height: 54vh;padding:0;border-bottom :solid #714789; border-left :solid #714789; border-right :solid #714789; border-bottom-left-radius: 2em;  border-bottom-right-radius: 2em;margin:0;">
					   		<div class="row" style="height: 54vh; margin: 0; overflow-y: auto;">
...
<?php if($exist == 0){?>
	<script type="text/javascript">
		$('#div_eliminados').html('<div align="center"><h3><span class="label label-default">* Aqui aparecen los pedidos eliminados *</span></h3></div>');
	</script>
<?php }?>

<div class="row">
	<div class="col-md-12 col-xs-12">
		...
		<?php } else if($objeto['promocion'] == 1) { ?>
			<button 
					onclick="$('#div_promocion').html(comandera.htmlPromo)" 
					type="button" 
					style="background-color: #D6872D; color:white;"
					class="btn">
					<i class="fa fa-ban"></i> Cancelar
	...
	if($key == 'opcionales'){ ?>
		<div class="panel panel-default" style="width: calc(100% - 30px); margin-left: 15px;">
			<div class="panel-heading">
				<div class="row">
					<div class="col-md-3" style="padding-top: 5px">
						<h4 class="panel-title">Opcionales:</h4>
					</div>
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-xs-9" id="div_opcionales_opcional">

						<?php if($gruposi != 1){ ?>							
							<?php foreach($value as $k => $v) { ?>															
										<div class = "pull-left" style = "padding:5px" >
											<button type="button" id="btn_opcional_<?php echo $v['idProducto'] ?>"
												onclick="comandera.seleccionar_opc({
													id_producto: <?php echo $v['idProducto'] ?>,
													grupo: 3,
													id_productoR: <?php echo $id_productoR; ?>,
												})" 
												class="btn btn-default btn_opcional" 
												style="width: 120px;height: 60px; font-weight: bold; white-space: normal;">
												<div class="row">
													<div style="font-weight: bold;" class=""> <?php echo substr($v['nombre'], 0, 25)  ?> </div>
												</div>
											</button>
										</div>														
								<?php } ?>	
						...
						<?php }else{ ?>
										...
										<?php if($v['id_grupo'] == 1){	?>								
											<div class = "pull-left" style = "padding:5px" >
												<button type="button" id="btn_opcional_<?php echo $v['idProducto'] ?>"
													...
													class="btn btn-default btn_opcional valida1" 
													style="width: 120px;height: 60px; font-weight: bold; white-space: normal;">
													<div class="row">
														<div style="font-weight: bold;" class=""> <?php echo substr($v['nombre'], 0, 25)  ?> </div>
													</div>
							...
							<div class="panel panel-default">
							    <div class="panel-heading">Grupo 3</div>
							    <div class="panel-body">						  					
									<?php foreach($value as $k => $v) { ?>								
										<?php if($v['id_grupo'] == 3){	?>								
											<div class = "pull-left" style = "padding:5px" >
					...
					<div class="col-xs-3 pull-right">
						<div class="form-group">
					      <label for="disabledTextInput">Nota: </label>
				...
				<div class="row">
					...
					<div class="col-md-9" align="right">
						<button 
							...
							onclick="comandera.reiniciar_opcionales({
									grupo: 1,
									id_productoR: <?php $objeto_json['id_producto'] ?>									
								})">
							<i class="fa fa-undo"></i> Reiniciar
						</button>
					</div>

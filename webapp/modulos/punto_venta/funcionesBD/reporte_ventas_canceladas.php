...
//---------------------------------------------------------------------------------
	...
	function cargaReporte($connection)
	{
		...
		$primerquery = "	SELECT v.idVenta, 
										...
										v.monto, v.rfc, v.documento, v.fecha, v.cambio, v.montoimpuestos, v.estatus, v.fecha_modifica 
										FROM venta v
		...
		$tabla = "<section id='reporte_ventas'>";
		
		$result = $connection->query($primerquery.$filtro.";");

		if($result->num_rows > 0)
		{
			$tabla .= "<table class='busqueda table' cellpadding='0' cellspacing='0' style='font-size: 12px;'>
			...
			for($i=0; $i<count($row); $i++)
			{
				...
				$tabla .= "  
						<tr  class='busqueda_fila'  style=' color:#6E6E6E; font-size: 10pt;'>
							<td style=''>	<center> ".$row[$i]['fecha']."</center></td>
        					<td style=''>	<center> ".$row[$i]['idVenta']."</center></td>";
        					
        					
				if($row[$i]['idCliente'] == NULL)
				{
					$tabla .= "<td style=''>Público en general</td>";
				}			
				else 
				{
					$tabla .= "<td style=''>	".utf8_encode($row[$i]['nombrecliente'])."</td>";
				}			
				if($simple == 1)
							$tabla .= "<td style=''>	<center> ".utf8_encode($row[$i]['nombresucursal'])."</center></td>";
        		$tabla .= "	<td style=''>	".utf8_encode($row[$i]['nombreempleado'])."</td>
        					<td style=''>	<center>";
        		...
        		$tabla .= "	</center></td>
							<td style=''>	<center>$".number_format($row[$i]['cambio'], 2, '.', '')."</center></td>
							<td style=''>	<center>$".number_format(($row[$i]['monto'] - $row[$i]['montoimpuestos']), 2, '.', ',')."</center></td>
        					<td style=''>	<center>$".number_format($row[$i]['montoimpuestos'], 2, '.', ',')."</center></td>
        					<td style=''>	<center>".$row[$i]['fecha_modifica']."</center></td>
						</tr>";
			...
			if($simple == 1)
				...
				$tabla .= "	<td style='font-size: 14px;font-weight:bold;text-align: right;' colspan=5> <b>Subtotal </b></td>";
			...
			if($simple == 1)
				$tabla .= "	<tr style='background:#333333;color: #FFFFFF'>
							<td style='font-size: 14px;font-weight:bold;text-align: right;' colspan=7> <b>Total </b></td>
							<td style='font-size: 14px;font-weight:bold' colspan=2>	<center>$".number_format(($totaliva+$totalmonto), 2, '.', ',')."</center></td>
						</tr>";
			else
				$tabla .= "	<tr>
							<td style='font-size: 14px;font-weight:bold;text-align: right;' colspan=6> <b>Total </b></td>
							<td style='font-size: 14px;font-weight:bold' colspan=2>	<center>$".number_format(($totaliva+$totalmonto), 2, '.', ',')."</center></td>
						</tr>";
			...
			if($opc == 1)
			{
				for($i=0; $i<count($row); $i++)
				{
					...
					if($i==0)
					{
						...
						$tabla .= "<table class='busqueda' cellpadding='0' cellspacing='0' width='100%' style='min-width: 100%; font-size: 12px;'>
					...
					else
					{
						if ($simple == 1)
						{	$tabla .= "	<tr style='background:#333333;color: #FFFFFF'>
									<td style='font-size: 14px;font-weight:bold;text-align: right;' colspan=5> <b>Subtotal </b></td>
						...
						{
							$tabla .= "	<tr style='background:#333333;color: #FFFFFF'>
									<td style='font-size: 14px;font-weight:bold;text-align: right;' colspan=4> <b>Subtotal </b></td>
									<td style='font-size: 14px;font-weight:bold;'>	<center>$".number_format($sumacambio, 2, '.', ',')."</center></td>
									<td style='font-size: 14px;font-weight:bold;'>	<center>$".number_format($sumamonto, 2, '.', ',')."</center></td>
			    					<td style='font-size: 14px;font-weight:bold;'>	<center>$".number_format($sumaiva, 2, '.', ',')."</center></td>
								</tr>";	
							$tabla .= "	<tr style='background:#333333;color: #FFFFFF'>
								<td style='font-size: 14px;font-weight:bold;text-align: right;;' colspan=5> <b>Total </b></td>
								<td style='font-size: 14px;font-weight:bold;' colspan=2>	<center>$".number_format(($sumaiva+$sumamonto), 2, '.', ',')."</center></td>
							</tr>";
						}
						$tabla .= "</table><br><br>";
				...
				{	$tabla .= "	<tr style='background:#333333;color: #FFFFFF'>
					...
					$total += $sumaiva+$sumamonto;//administrador filtro
					$tabla .= "	<br><br><br><table cellpadding='0' cellspacing='0' width='100%' style='min-width: 100%; font-size: 12px;'>
					<tr style='background:#333333;color: #FFFFFF'>
							<td style='font-size: 14px;font-weight:bold;	text-align: center;height: 34px;' colspan=7> <b>Total de ventas  $".number_format(($total), 2, '.', ',')."</b></td>
			...
			else if($opc == 4)
			{
				...
				for($i=0; $i<count($row); $i++)
				{
					...
					if($i==0)
					{
					    ...
					    $tabla .= "	</center></td>
											<td style=' '>	<center>".$row[$i]['cantidad']."</center></td>
											<td style=''>	<center>$".number_format($row[$i]['cambio'], 2, '.', ',')."</center></td>
											<td style=''>	<center>$".number_format(($row[$i]['monto'] - $row[$i]['montoimpuestos']), 2, '.', ',')."</center></td>
					    					<td style=''>	<center>$".number_format($row[$i]['montoimpuestos'], 2, '.', ',')."</center></td>
										</tr>";
					...
					else
					{
						...
						{
							$tabla .= "	<tr style='background:#333333;color: #FFFFFF'>
									<td style='font-size: 14px;font-weight:bold;text-align: right;' colspan=6> <b>Subtotal </b></td>
								...
								$tabla .= "	<tr style='background:#333333;color: #FFFFFF'>
									<td style='font-size: 14px;font-weight:bold;text-align: right;' colspan=8> <b>Total </b></td>
									<td style='font-size: 14px;font-weight:bold' colspan=2>	<center>$".number_format(($sumaiva+$sumamonto), 2, '.', ',')."</center></td>
								</tr>";
							$tabla .= "</table><br><br>";
						}

...
<div class="container">
	<div class="row">
		...
		<div class="col-md-15 col-sm-15">
			<h3 class="nmwatitles text-center">Importar clientes</h3>
			<section style="min-height: 650px; background: transparent url('../../img/clientes.png') no-repeat scroll center center / cover ;">
				<br> <br>
				<div class="row">
				...
				<form id="myForm" action=<?php echo $url; ?> method="post" enctype="multipart/form-data">
					<div class="row" style="margin-top: 13em !important;">
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-md-12">
						<img src='../../img/xls_icon.gif'> <a href='importacion_masiva_de_clientes.xlsx'>Descarga la plantilla para los clientes</a>
						<hr/>

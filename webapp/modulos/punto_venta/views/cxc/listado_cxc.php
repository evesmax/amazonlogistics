		...
		<div class="container" style="width:100%">
			<div class="row">
				...
				<div class="col-sm-10" id="imp_cont">
					...
					<h4>Filtro de b&uacute;squeda por cuenta por cobrar</h4>
					<div class="row">
						<div class="col-sm-4">
					...
					<div class="row">
						<div class="col-sm-3">
							<input type="button" value="Buscar cuentas por cobrar" onclick="buscacxc();" class="btn btn-primary btnMenu" />
						</div>
						<div class="col-sm-3">
							<input type="button" value="Limpiar filtros" onclick="limpiafiltroscxc();" class="btn btn-primary btnMenu"/>
						</div>
						<div class="col-sm-3">

$(function(){
	...
	function busquedas(evt,val,campo)
	{
				...
				if(key==13)
				{
					var filtro=1;
						...
						{
								switch(campo)
								{//elect t.idTal,t.talla from mrp_talla t
									case 'id': filtro+=" and t.idTal='"+val+"'"; break;		
									case 'talla': filtro+=" and t.talla like '%"+val+"%'"; break;
    ...
    function abrir(nuevo,modificar,eliminar)
    {
     ...
     var frop = document.getElementById("opciones");                        
        $.ajax({type: 'GET',url:'../../../netwarelog/catalog/gestor.php?idestructura=82',data:{},success:function(resp){ 
        	...
        	else 
        	{
                 if(modificar==1)
                  {
                    	url="../../../modulos/punto_venta/catalogos/gridtalla.php";                            
                  } 
                  else 
                  {
                   		url="../../../modulos/punto_venta/catalogos/gridtalla.php?elimina=1";                          
                  }
             }      
        	frop.src = url;
        	}});//end ajax		   

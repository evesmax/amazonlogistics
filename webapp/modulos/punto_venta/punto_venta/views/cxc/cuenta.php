...
<div id="formulario">
	...
	<center>
		...
		<input type="hidden" id="id_cxc" 	<?php
												if(isset($_REQUEST['id']))
		...
		?>
			...
			<b>Crear nueva cuenta por cobrar</b><p>
				...
				<div class="listadofila" 						style="display: table; padding: 10px; width: 70%; text-align: left;">	
					...
					<div title="Saldos" style="display: table-cell; width: 70%; padding: 10px;">
						<div style='display: table; width: 100%;'>
							<div style='display: table-cell; width: 70%; padding-right: 10px;'><b><label>Cliente</label></b><br> 				<input id="cliente" 	  		type="text" style="width: 100%;"></div>
							<div style='display: table-cell; width: 30%;'><b><label>Folio de venta</label>  </b><br> 				<input id="folio" 	  		type="text" style="width: 100%;"></div>	
						</div>
						<p>

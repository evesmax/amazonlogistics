<?php include("../../funcionesBD/gridP.php") ?>
	...
	<body>
		...
		<fieldset><legend>Filtro de b&uacute;squeda por cuenta por pagar</legend>	
		<table>
			<tr>
				...
				<td><label><input type="button" value="Buscar cuentas por pagar" onclick="buscacxp();" /></td>
				<td><img id="preloader" src="../../../../modulos/mrp/images/preloader.gif">	</td>
			</tr>
			<tr>
				<td><label><input type="button" value="Limpiar filtros" onclick="limpiafiltroscxp();" /></td>
			</tr>
		</table>	
		</fieldset>	

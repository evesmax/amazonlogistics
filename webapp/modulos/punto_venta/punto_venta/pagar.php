...
<tr>
	...
	<td>
				...
				-->	
					...
					<tr>	
							<input maxlength="6"  type="hidden"  id="total-impuestos" value="<?php echo ($impuestos);?>">
							<td align="center"><input type="hidden" id="super-total" value="<?php echo ($total);?>"><div id="pagar-total">Total:$<?php echo number_format($total,2,".",",");  ?></div></td>
					</tr>
					<tr>	
							<td  align="center">

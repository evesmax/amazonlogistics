...
//---------------------------------------------------------------------------------
	...
	function cargaReporte($connection)
	{
		...
		if($result->num_rows > 0)
		{
			$tabla .= "<table cellpadding='0' cellspacing='0' width='100%' style='min-width: 100%; font-size: 12px;'>
				<tr>
					<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; border-left: 1px solid #FF0040;'>	Fecha de venta</th>
					<th width=5%  style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Folio</th>
					<th width=15% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Cliente</th>";
			if($simple == 1)		
				$tabla .=	"<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Sucursal</th>";
					
			$tabla .="<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Vendedor</th>
					<th width=20% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Formas de pago</th>
					<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; background-color: #F781BE;'>		Cambio</th>
					<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; background-color: #58FA82;'>		Total venta</th>
					<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; background-color: #F3F781; border-right: 1px solid #FF0040;'>IVA</th>
				</tr>";
			...
			for($i=0; $i<count($row); $i++)
			{
				...
				$tabla .= "  
						<tr>
							<td style='border-bottom: 1px solid #CCCCCC; border-right: 1px solid #CCCCCC; border-left: 1px solid #FF0040;'>	<center> ".$row[$i]['fecha']."</center></td>
        		...
        		$tabla .= "	</center></td>
        					...
        					<td style='border-bottom: 1px solid #CCCCCC; border-right: 1px solid #FF0040; background-color: #F3F781;'>	<center>$".number_format($row[$i]['montoimpuestos'], 2, '.', ',')."</center></td>
						</tr>";
			...
			$tabla .= "	<tr>";
			if($simple == 1)
				$tabla .= "		<td style='									 border-top: 1px solid #FF0040; 								 text-align: right;			height: 34px;' colspan=6> <b>Subtotal </b></td>";
			else
				$tabla .= "		<td style='									 border-top: 1px solid #FF0040; 								 text-align: right;			height: 34px;' colspan=5> <b>Subtotal </b></td>";
			$tabla .= "		<td style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; border-left: 1px solid #FF0040;  background-color: #F781BE; height: 34px;'>	<center>$".number_format($totalcambio, 2, '.', ',')."</center></td>
							<td style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; 								 background-color: #58FA82; height: 34px;'>	<center>$".number_format($totalmonto, 2, '.', ',')."</center></td>
        					<td style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; border-right: 1px solid #FF0040; background-color: #F3F781; height: 34px;'>	<center>$".number_format($totaliva, 2, '.', ',')."</center></td>
						</tr>";
			
			if($simple == 1)
				$tabla .= "	<tr>
							<td style='									 								 text-align: right;			height: 34px;' colspan=7> <b>Total </b></td>
							<td style='border: 1px solid #FF0040; 		 background-color: #00BFFF; height: 34px;' colspan=2>	<center>$".number_format(($totaliva+$totalmonto), 2, '.', ',')."</center></td>
						</tr>";
			else
				$tabla .= "	<tr>
		...
		else
		{
			...
			{
				$tabla .= "<br><br><br><div style='color: #FF0040;'>No se encontraron ventas recientes</div><br><br><br><br>";
				$tabla .= "</div></center>";
			}
			echo $tabla;
		}
	...
	function cargaReporteAgrupado($connection)
	{
		...
		if($result->num_rows > 0)
		{
			...
			if($opc == 1)
			{
				for($i=0; $i<count($row); $i++)
				{
					...
					if($i==0)
					{
						$tabla .= "<div style='text-align: left; font-size: 14px; color: #FF0040;'>".$row[$i]['nombreempleado']."</div><br>"; 
						$tabla .= "<table cellpadding='0' cellspacing='0' width='100%' style='min-width: 100%; font-size: 12px;'>
							<tr>
								<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; border-left: 1px solid #FF0040;'>	Fecha de venta</th>
								<th width=5%  style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Folio</th>
						...
						if($simple == 1)
							$tabla .= "	<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>				Sucursal</th>";
						$tabla .= "	<th width=20% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Formas de pago</th>
								<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; background-color: #F781BE;'>		Cambio</th>
								<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; background-color: #58FA82;'>		Total venta</th>
								<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; background-color: #F3F781; border-right: 1px solid #FF0040;'>IVA</th>
							</tr>";
					...
					else
					{
						if ($simple == 1)
						{	$tabla .= "	<tr>
									<td style='									 border-top: 1px solid #FF0040; 								 text-align: right;			height: 34px;' colspan=5> <b>Subtotal </b></td>
									<td style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; border-left: 1px solid #FF0040;  background-color: #F781BE; height: 34px;'>	<center>$".number_format($sumacambio, 2, '.', ',')."</center></td>
									<td style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; 								 background-color: #58FA82; height: 34px;'>	<center>$".number_format($sumamonto, 2, '.', ',')."</center></td>
			    					<td style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; border-right: 1px solid #FF0040; background-color: #F3F781; height: 34px;'>	<center>$".number_format($sumaiva, 2, '.', ',')."</center></td>
								</tr>";
								$tabla .= "	<tr>
								<td style='									 								 text-align: right;			height: 34px;' colspan=6> <b>Total </b></td>
								<td style='border: 1px solid #FF0040; 		 background-color: #00BFFF; height: 34px;' colspan=2>	<center>$".number_format(($sumaiva+$sumamonto), 2, '.', ',')."</center></td>
								</tr>";
						}
						else
						{
							$tabla .= "	<tr>
									<td style='									 border-top: 1px solid #FF0040; 								 text-align: right;			height: 34px;' colspan=4> <b>Subtotal </b></td>
									<td style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; border-left: 1px solid #FF0040;  background-color: #F781BE; height: 34px;'>	<center>$".number_format($sumacambio, 2, '.', ',')."</center></td>
									<td style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; 								 background-color: #58FA82; height: 34px;'>	<center>$".number_format($sumamonto, 2, '.', ',')."</center></td>
			    					<td style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; border-right: 1px solid #FF0040; background-color: #F3F781; height: 34px;'>	<center>$".number_format($sumaiva, 2, '.', ',')."</center></td>
								</tr>";	
				...
				{	$tabla .= "	<tr>
					...
					$tabla .= "	<br><br><br><table cellpadding='0' cellspacing='0' width='100%' style='min-width: 100%; font-size: 12px;'><tr>
							...
							<td style='border: 1px solid #FF0040; 		 background-color: #DA81F5; height: 34px;' colspan=2>	<center>$".number_format(($total), 2, '.', ',')."</center></td>
						</tr>";
			...
			else if($opc == 2)
			{
				for($i=0; $i<count($row); $i++)
				{
					...
					{
						if($row[$i]['idCliente'] == NULL)
							$tabla .= "<div style='text-align: left; font-size: 14px; color: #FF0040;'>Público en general</div><br>"; 
						else 
							$tabla .= "<div style='text-align: left; font-size: 14px; color: #FF0040;'>".$row[$i]['nombrecliente']."</div><br>"; 
			...
			else if($opc == 3)
			{
				for($i=0; $i<count($row); $i++)
				{
					...
					if($i==0)
					{
						$tabla .= "<div style='text-align: left; font-size: 14px; color: #FF0040;'>".$row[$i]['nombresucursal']."</div><br>"; 
						...
						$tabla .= "<table cellpadding='0' cellspacing='0' width='100%' style='min-width: 100%; font-size: 12px;'>
							<tr>
								...
								<th width=5%  style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Folio</th>
								<th width=15% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Cliente</th>
								<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Vendedor</th>
								<th width=20% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Formas de pago</th>
								<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; background-color: #F781BE;'>		Cambio</th>
								<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; background-color: #58FA82;'>		Total venta</th>
								<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; background-color: #F3F781; border-right: 1px solid #FF0040;'>IVA</th>
			...
			else if($opc == 4)
			{
				...
				for($i=0; $i<count($row); $i++)
				{
					...
					if($i==0)
					{
						$tabla .= "<div style='text-align: left; font-size: 14px; color: #FF0040;'>".$row[$i]['nombreproducto']."</div><br>"; 
						
						$tabla .= "<table cellpadding='0' cellspacing='0' width='100%' style='min-width: 100%; font-size: 12px;'>
							<tr>
								<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; border-left: 1px solid #FF0040;'>	Fecha de venta</th>
								<th width=5%  style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Folio</th>
								<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Cliente</th>";
						if($simple == 1)
							$tabla .= "<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Sucursal</th>";
						$tabla .= "<th width=15% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Vendedor</th>
								<th width=15% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Formas de pago</th>
								<th width=5%  style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040;'>									Cantidad</th>
								<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; background-color: #F781BE;'>		Cambio</th>
								<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; background-color: #58FA82;'>		Total venta</th>
								<th width=10% style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; background-color: #F3F781; border-right: 1px solid #FF0040;'>Impuestos</th>
							</tr>";
					...
					else
					{
						...
						{
							$tabla .= "	<tr>
									<td style='									 border-top: 1px solid #FF0040; 								 text-align: right;			height: 34px;' colspan=6> <b>Subtotal </b></td>
									<td style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; border-left: 1px solid #FF0040;  height: 34px;'>	<center>".$sumacantidad."</center></td>
									<td style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; border-left: 1px solid #FF0040;  background-color: #F781BE; height: 34px;'>	<center>$".number_format($sumacambio, 2, '.', ',')."</center></td>
									<td style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; 								 background-color: #58FA82; height: 34px;'>	<center>$".number_format($sumamonto, 2, '.', ',')."</center></td>
			    					<td style='border-bottom: 1px solid #FF0040; border-top: 1px solid #FF0040; border-right: 1px solid #FF0040; background-color: #F3F781; height: 34px;'>	<center>$".number_format($sumaiva, 2, '.', ',')."</center></td>
								</tr>";
		...
		{
			$tabla .= "<br><br><br><div style='color: #FF0040;'>No se encontraron ventas canceladas recientes</div><br><br><br><br>";
			$tabla .= "</div></center>";
			echo $tabla;
		}
	}

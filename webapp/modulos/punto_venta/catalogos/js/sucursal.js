...
///////////////////////////////////////////////////////////////
				...
				if(key==13)
				{
					var filtro=1;
						if(val!="")
						{
								...
								switch(campo)
								{
									case 'id': filtro+=" and a.idSuc='"+val+"'"; break;		
									...
									case 'almacen': filtro+=" and aa.nombre like '%"+val+"%'"; break;
								}	
						}
					if($("#elimina").val()==0)
						{	
    ...
    function abrir(nuevo,modificar,eliminar)
    {
     ...
     var frop = document.getElementById("opciones");                        
        $.ajax({type: 'GET',url:'../../../netwarelog/catalog/gestor.php?idestructura=86',data:{},success:function(resp){ 
        	...
        	else 
        	{
                 if(modificar==1)
                  {
                    	url="../../../modulos/punto_venta/catalogos/gridsucursal.php";                            
                  } 
                  else 
                  {
                   		url="../../../modulos/punto_venta/catalogos/gridsucursal.php?elimina=1";                          
                  }
             }      
        	frop.src = url;
        	}});//end ajax		   

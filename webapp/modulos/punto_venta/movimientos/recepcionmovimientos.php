						...
						<div class="table-responsive">
							<table class="busqueda table" id="datos" cellpadding="3" cellspacing="1"  >
								...
								<?php
									...
									SELECT mm.id, (select nombre from almacen where idAlmacen=mm.idAlmacenOrigen) almacenorigen,
										...
										<tr class="<?php echo $color; ?>" style=" color:#6E6E6E; font-size: 10pt;">
											...
											<td align="center">
												...
												if($lista['usuarioentrada']==''){
													...
													<img src="../img/loader.gif" alt="" style="display:none;" id="loader_<?php echo $lista['id']; ?>"> <?php
												}else{

					...
					if( sucursal !== null && sucursal.toString() !== "" )
					{
						$.get('../controllers/report.php',
							...
							else
							{
								...
								//alert(data.length);
								/*for (var i = data.length - 1; i >= 10; i++)
								{
									date = data[i].Nombre.toString();
									monto = parseFloat( data[i].Ventas, 10 );
									line = [ date, monto ];
									reportArray2.push( line );
								} */
								//console.log(data);
								$.each(data, function(index, val) {
									
									date = data[index].Nombre.toString();
									monto = parseFloat( data[index].Ventas, 10 );
									line = [ date, monto ];
									reportArray2.push( line );
									if(index >= 9){
										return false;
								...
								//console.log(reportArray2);
								if (reportArray.length > 0)
								{
									if( $("#bars").prop( 'checked' )   === true )
									{
										bar_rendering( reportArray2, "Reporte: Ventas por Producto", "chart1" );
									}
									else
									{
										$("#chart1").html("").hide();
									...
									{
										line_render( reportArray2, "Reporte: Ventas por Producto", "chart2" );
									}
									else
									{
										$("#chart2").html("").hide();
									...
									{
										hybridRender(reportArray2, "Reporte: Ventas por Producto","chart3");
									}
									else
									{
										$("#chart3").html("").hide();
									...
									{
										reportArray = order(reportArray2);

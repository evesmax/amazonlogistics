   ...
   //VARIABLES DEL ENVIO
		...
		$sqlestatus="Select lt.idtraslado,lt.referencia1 otfc, lt.fecha,  
                                ...
                                of.idfabricante, obo.idbodega, obd.idbodega idbodegadestino, ot.idtransportista, lt.idproducto,
									...
									obd.responsable, '' licenciaoperador
...
//DATOS BODEGA ORIGEN
		...
		$html.="<center><table class='reporte' width='100%'>";
			...
			//Obteniendo los datos
				...
				$html.="<tr class=trcontenido>";
                                        $html.="<td align=right><input type=text value=".$cantidad1." id='txtcantenv1' name='txtcantenv1' size=20></td>";
					$html.="<td align=right><input type=text value=".$cantidad2." id='txtcantenv2' name='txtcantenv2' size=20></td>";			

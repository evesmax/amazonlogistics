...
//FIN POLITICAS
    ...
    <head>
        <meta charset="utf-8">
        <title>Error al registrar la recepción</title>
        <style>
            body {
    ...
    <body>
        <div class="error-container">
            ...
            <div class="error-message">Error al registrar la recepción:<br><?php echo htmlspecialchars($e->getMessage()); ?></div>
            <div class="button-group">
                <a href="javascript:history.back();" class="btn btn-primary">Regresar y Corregir</a>
                <a href="recepcion.php" class="btn btn-secondary">Nueva Captura</a>
            </div>
        </div>
    </body>
    </html>

...
export default {
  name: 'ExistenciaCaracteristicas',
  ...
  data () {
    return {
      config: {
        thead: ['Almacén', 'Caracteristicas', 'Unidad de medida',  'Existencia', 'Apartados', 'Disponible'],
        tfoot: ['Almacén', 'Caracteristicas', 'Unidad de medida',  'Existencia', 'Apartados', 'Disponible'],

...
export default {
  ...
  data () {
    return {
      config: {
        thead: ['Almacén', 'Serie', 'Unidad de medida', 'Método de costeo', 'Monto Unitario', 'Existencia', 'Apartados', 'Disponible'],
        tfoot: ['Almacén', 'Serie', 'Unidad de medida', 'Método de costeo', 'Monto Unitario', 'Existencia', 'Apartados', 'Disponible'],
        columns: [
          {

...
export default {
  ...
  data () {
    return {
      config: {
        thead: ['Almacén', 'Lote', 'Unidad de medida', 'Método de costeo', 'Monto Unitario', 'Existencia', 'Apartados', 'Disponible'],
        tfoot: ['Almacén', 'Lote', 'Unidad de medida', 'Método de costeo', 'Monto Unitario', 'Existencia', 'Apartados', 'Disponible'],

  ...
  data () {
    return {
      config: {
        ...
        scrollY: "450px",
        bPaginate: false,
        thead: ['Folio', 'Fecha y hora', 'Responsable', 'Atributos', 'Detalle', 'Almacén Destino', 'Almacén Origen', 'Entrada Cantidad', 'Salida Cantidad', 'Saldo Cantidad', ],
        tfoot: ['Folio', 'Fecha y hora', 'Responsable', 'Atributos', 'Detalle', 'Almacén Destino', 'Almacén Origen', 'Entrada Cantidad', 'Salida Cantidad', 'Saldo Cantidad', ],
        columns: [
          { data: 'ID_MOVIMIENTO'},
          { data: 'FECHA' },
          { data: 'RESPONSABLE' },
